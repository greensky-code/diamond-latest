    ...
    updateProfsvcClaimDetail(seqClaimId : number) {
        ...
        this.profsvcClaimDetailService.getProfsvcClaimDetail(seqClaimId).subscribe(profsvcClaimDetail => {
            ...
            this.claimDisplayTotalsForm.patchValue({
                'claimNumber': this.profsvcClaimDetail.lineNumber,
                'totalBilled': this.profsvcClaimDetail.totalUnits,
                ...
                'totalNet': this.profsvcClaimDetail.anesTotalTime,
                'totalCobPt': this.dateFormatPipe.defaultDisplayDateFormat(this.profsvcClaimDetail.detailSvcDate),
