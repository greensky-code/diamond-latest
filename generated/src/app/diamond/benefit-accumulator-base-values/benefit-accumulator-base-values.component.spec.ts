...
describe('BenefitAccumulatorBaseValuesComponent', () => {
    ...
    describe('with BenefitAccumulatorBaseValuesComponent setup', BenefitAccumulatorBaseValuesComponentSetup);
...
let de: DebugElement;
let comp: BenefitAccumulatorBaseValuesComponent;
...
function BenefitAccumulatorBaseValuesComponentSetup() {
    describe('BenefitAccumulatorBaseValuesComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('BenefitAccumulatorBaseValuesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(BenefitAccumulatorBaseValuesComponent, {
                set: {
                    providers: [
