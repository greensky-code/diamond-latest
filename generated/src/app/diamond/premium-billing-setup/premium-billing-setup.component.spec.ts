...
import { PremiumBillingSetupComponent } from './premium-billing-setup.component';
...
describe('PremiumBillingSetupComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PremiumBillingSetupComponent setup', PremiumBillingSetupComponentSetup);
...
let de: DebugElement;
let comp: PremiumBillingSetupComponent;
let fixture: ComponentFixture<PremiumBillingSetupComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(PremiumBillingSetupComponent);
...
function PremiumBillingSetupComponentSetup() {
    describe('PremiumBillingSetupComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PremiumBillingSetupComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('PremiumBillingSetupComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PremiumBillingSetupComponent, {
                set: {
                    providers: [
