...
describe('GlReferenceComponent', () => {
    ...
    describe('with GlReferenceComponent setup', GlReferenceComponentSetup);
...
function GlReferenceComponentSetup() {
    describe('GlReferenceComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('GlReferenceComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(GlReferenceComponent, {
                set: {
                    providers: [
