...
import { AuthBatchCloseSetupComponent } from './auth-batch-close-setup.component';
...
describe('AuthBatchCloseSetupComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AuthBatchCloseSetupComponent setup', AuthBatchCloseSetupComponentSetup);
...
let de: DebugElement;
let comp: AuthBatchCloseSetupComponent;
let fixture: ComponentFixture<AuthBatchCloseSetupComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AuthBatchCloseSetupComponent);
...
function AuthBatchCloseSetupComponentSetup() {
    describe('AuthBatchCloseSetupComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AuthBatchCloseSetupComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AuthBatchCloseSetupComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthBatchCloseSetupComponent, {
                set: {
                    providers: [
