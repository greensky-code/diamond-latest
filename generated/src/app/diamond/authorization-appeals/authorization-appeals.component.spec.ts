...
import { AuthorizationAppealsComponent } from './authorization-appeals.component';
...
describe('AuthorizationAppealsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AuthorizationAppealsComponent setup', AuthorizationAppealsComponentSetup);
...
let de: DebugElement;
let comp: AuthorizationAppealsComponent;
let fixture: ComponentFixture<AuthorizationAppealsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AuthorizationAppealsComponent);
...
function AuthorizationAppealsComponentSetup() {
    describe('AuthorizationAppealsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AuthorizationAppealsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AuthorizationAppealsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthorizationAppealsComponent, {
                set: {
                    providers: [
