...
import { CoveringProviderGroupCodesComponent } from './covering-provider-group-codes.component';
...
describe('CoveringProviderGroupCodesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with CoveringProviderGroupCodesComponent setup', CoveringProviderGroupCodesComponentSetup);
...
let de: DebugElement;
let comp: CoveringProviderGroupCodesComponent;
let fixture: ComponentFixture<CoveringProviderGroupCodesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(CoveringProviderGroupCodesComponent);
...
function CoveringProviderGroupCodesComponentSetup() {
    describe('CoveringProviderGroupCodesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CoveringProviderGroupCodesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('CoveringProviderGroupCodesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(CoveringProviderGroupCodesComponent, {
                set: {
                    providers: [
