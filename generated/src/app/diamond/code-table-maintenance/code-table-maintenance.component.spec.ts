...
import { CodeTableMaintenanceComponent } from './code-table-maintenance.component';
...
describe('CodeTableMaintenanceComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with CodeTableMaintenanceComponent setup', CodeTableMaintenanceComponentSetup);
...
let de: DebugElement;
let comp: CodeTableMaintenanceComponent;
let fixture: ComponentFixture<CodeTableMaintenanceComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(CodeTableMaintenanceComponent);
...
function CodeTableMaintenanceComponentSetup() {
    describe('CodeTableMaintenanceComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CodeTableMaintenanceComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('CodeTableMaintenanceComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(CodeTableMaintenanceComponent, {
                set: {
                    providers: [
