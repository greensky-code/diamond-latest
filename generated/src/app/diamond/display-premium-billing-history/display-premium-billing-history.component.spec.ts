...
import { DisplayPremiumBillingHistoryComponent } from './display-premium-billing-history.component';
...
describe('DisplayPremiumBillingHistoryComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with DisplayPremiumBillingHistoryComponent setup', DisplayPremiumBillingHistoryComponentSetup);
...
let de: DebugElement;
let comp: DisplayPremiumBillingHistoryComponent;
let fixture: ComponentFixture<DisplayPremiumBillingHistoryComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(DisplayPremiumBillingHistoryComponent);
...
function DisplayPremiumBillingHistoryComponentSetup() {
    describe('DisplayPremiumBillingHistoryComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [DisplayPremiumBillingHistoryComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('DisplayPremiumBillingHistoryComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(DisplayPremiumBillingHistoryComponent, {
                set: {
                    providers: [
