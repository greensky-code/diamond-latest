...
import { MemberWorkingAgedComponent } from './member-working-aged.component';
...
describe('MemberWorkingAgedComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with MemberWorkingAgedComponent setup', MemberWorkingAgedComponentSetup);
...
let de: DebugElement;
let comp: MemberWorkingAgedComponent;
let fixture: ComponentFixture<MemberWorkingAgedComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(MemberWorkingAgedComponent);
...
function MemberWorkingAgedComponentSetup() {
    describe('MemberWorkingAgedComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MemberWorkingAgedComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MemberWorkingAgedComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MemberWorkingAgedComponent, {
                set: {
                    providers: [
