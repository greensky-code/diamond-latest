...
import { MemberMedicareChoiceHistoryComponent } from './member-medicare--choice-history.component';
...
describe('MemberMedicareChoiceHistoryComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with MemberMedicareChoiceHistoryComponent setup', MemberMedicareChoiceHistoryComponentSetup);
...
let de: DebugElement;
let comp: MemberMedicareChoiceHistoryComponent;
let fixture: ComponentFixture<MemberMedicareChoiceHistoryComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(MemberMedicareChoiceHistoryComponent);
...
function MemberMedicareChoiceHistoryComponentSetup() {
    describe('MemberMedicareChoiceHistoryComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MemberMedicareChoiceHistoryComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MemberMedicareChoiceHistoryComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MemberMedicareChoiceHistoryComponent, {
                set: {
                    providers: [
