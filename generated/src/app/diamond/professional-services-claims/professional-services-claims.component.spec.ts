...
import { ProfessionalServicesClaimsComponent } from './professional-services-claims.component';
...
describe('ProfessionalServicesClaimsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ProfessionalServicesClaimsComponent setup', ProfessionalServicesClaimsComponentSetup);
...
let de: DebugElement;
let comp: ProfessionalServicesClaimsComponent;
let fixture: ComponentFixture<ProfessionalServicesClaimsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ProfessionalServicesClaimsComponent);
...
function ProfessionalServicesClaimsComponentSetup() {
    describe('ProfessionalServicesClaimsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ProfessionalServicesClaimsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ProfessionalServicesClaimsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ProfessionalServicesClaimsComponent, {
                set: {
                    providers: [
