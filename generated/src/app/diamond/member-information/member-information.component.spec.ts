...
describe('MemberInformationComponent', () => {
    ...
    describe('with MemberInformationComponent setup', MemberInformationComponentSetup);
...
let de: DebugElement;
let comp: MemberInformationComponent;
...
function MemberInformationComponentSetup() {
    describe('MemberInformationComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('MemberInformationComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MemberInformationComponent, {
                set: {
                    providers: [
