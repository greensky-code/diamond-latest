...
// Use the Component directive to define the TaxonomyCodeComponent as an Angular component
//
...
@Component({
    ...
    selector: 'taxonomycode',
    templateUrl: './taxonomy-code.component.html',

})
export class TaxonomyCodeComponent implements OnInit  {

    // The form model used by the view per Angular Reactive Forms
    // See: https://angular.io/docs/ts/latest/guide/reactive-forms.html#!#intro
    taxonomyCodeForm: FormGroup;
    ...
    ngOnInit(): void {
        ...
        this.createForm();
        this.displayMessage = {};
        this.formValidation = new FormValidation(this.taxonomyCodeForm);
    }
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.taxonomyCodeForm = this.formBuilder.group({
            taxonomyCode: ['', {updateOn: 'blur', validators: [] }],
