...
import { BenefitPackageUserFieldsComponent } from './benefit-package-user-fields.component';
...
describe('BenefitPackageUserFieldsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with BenefitPackageUserFieldsComponent setup', BenefitPackageUserFieldsComponentSetup);
...
let de: DebugElement;
let comp: BenefitPackageUserFieldsComponent;
let fixture: ComponentFixture<BenefitPackageUserFieldsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(BenefitPackageUserFieldsComponent);
...
function BenefitPackageUserFieldsComponentSetup() {
    describe('BenefitPackageUserFieldsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [BenefitPackageUserFieldsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('BenefitPackageUserFieldsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(BenefitPackageUserFieldsComponent, {
                set: {
                    providers: [
