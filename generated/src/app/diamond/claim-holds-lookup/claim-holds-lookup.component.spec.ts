...
import { ClaimHoldsLookupComponent } from './claim-holds-lookup.component';
...
describe('ClaimHoldsLookupComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimHoldsLookupComponent setup', ClaimHoldsLookupComponentSetup);
...
let de: DebugElement;
let comp: ClaimHoldsLookupComponent;
let fixture: ComponentFixture<ClaimHoldsLookupComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimHoldsLookupComponent);
...
function ClaimHoldsLookupComponentSetup() {
    describe('ClaimHoldsLookupComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimHoldsLookupComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimHoldsLookupComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimHoldsLookupComponent, {
                set: {
                    providers: [
