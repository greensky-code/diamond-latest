...
import {  PremiumMatrixHeader } from "../../api-models/index"
...
@Component({
    ...
    selector: 'armatrixpremiumrateentry',
...
editPremiumMatrixHeader: boolean;
    premiumMatrixHeader: PremiumMatrixHeader;
    premiumMatrixHeaders: PremiumMatrixHeader[];
    if (this.secWin.hasInsertPermission()) {
        createPremiumMatrixHeader() {
            ...
            if(this.arMatrixPremiumRateEntryForm.valid) {
                ...
                premiumMatrixHeader.matrixDescription = Form.getValue(this.arMatrixPremiumRateEntryForm, 'matrixDefinition');
                premiumMatrixHeader.matrixDeterminant = Form.getValue(this.arMatrixPremiumRateEntryForm, 'matrixDescription');
                premiumMatrixHeader.matrixCalcMethod = Form.getValue(this.arMatrixPremiumRateEntryForm, 'matrixCalcMethod');
                premiumMatrixHeader.matrixDef = Form.getValue(this.arMatrixPremiumRateEntryForm, 'matrixDeterminant');
                this.premiumMatrixHeaderService.createPremiumMatrixHeader(premiumMatrixHeader).subscribe(response => {
    ...
    updatePremiumMatrixHeader(matrixDef : string) {
        ...
        if(this.arMatrixPremiumRateEntryForm.valid) {
            ...
            premiumMatrixHeader.matrixCalcMethod = Form.getValue(this.arMatrixPremiumRateEntryForm, 'matrixCalcMethod');
            premiumMatrixHeader.matrixDef = Form.getValue(this.arMatrixPremiumRateEntryForm, 'matrixDeterminant');
            this.premiumMatrixHeaderService.updatePremiumMatrixHeader(premiumMatrixHeader, matrixDef).subscribe(response => {
        ...
        if(this.editPremiumMatrixHeader) {
            this.updatePremiumMatrixHeader(this.premiumMatrixHeader.matrixDef)
        } else {
        ...
        if (!(this.secWin && this.secWin.hasDeletePermission())) {
            ...
            this.premiumMatrixHeaderService.deletePremiumMatrixHeader(matrixDef).subscribe(response => {
        ...
        this.premiumMatrixHeaderService.getPremiumMatrixHeader(matrixDef).subscribe(premiumMatrixHeader => {
        ...
        this.premiumMatrixHeaderService.getPremiumMatrixHeaders().subscribe(premiumMatrixHeaders => {
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.arMatrixPremiumRateEntryForm = this.formBuilder.group({
            ...
            65: ['', {updateOn: 'blur', validators: [] }],
            69: ['', {updateOn: 'blur', validators: [] }],
