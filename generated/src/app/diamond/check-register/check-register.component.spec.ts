...
describe('CheckRegisterComponent', () => {
    ...
    describe('with CheckRegisterComponent setup', CheckRegisterComponentSetup);
...
let de: DebugElement;
let comp: CheckRegisterComponent;
...
function CheckRegisterComponentSetup() {
    describe('CheckRegisterComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('CheckRegisterComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(CheckRegisterComponent, {
                set: {
                    providers: [
