...
import {  CheckRegister } from "../../api-models/index"
import {  CheckRegisterService } from "../../api-services/check-register.service"
import { AlertMessage, AlertMessageService } from '../../shared/components/alert-message/index'
import { SecWinService } from '../../../api-services/security/sec-win.service';

// Use the Component directive to define the CheckRegisterComponent as an Angular component
//
...
editCheckRegister: boolean;
    ...
    updateCheckRegister(eftTransNumber : string) {
        ...
        this.checkRegisterService.getCheckRegisters().subscribe(checkRegisters => {
