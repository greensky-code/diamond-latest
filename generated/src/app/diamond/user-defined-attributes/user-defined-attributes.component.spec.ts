...
import { UserDefinedAttributesComponent } from './user-defined-attributes.component';
...
describe('UserDefinedAttributesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with UserDefinedAttributesComponent setup', UserDefinedAttributesComponentSetup);
...
let de: DebugElement;
let comp: UserDefinedAttributesComponent;
let fixture: ComponentFixture<UserDefinedAttributesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(UserDefinedAttributesComponent);
...
function UserDefinedAttributesComponentSetup() {
    describe('UserDefinedAttributesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [UserDefinedAttributesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('UserDefinedAttributesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(UserDefinedAttributesComponent, {
                set: {
                    providers: [
