...
import {  UserDefinedAttributes } from "../../api-models/index"
...
export class UserDefinedAttributesComponent implements OnInit  {
...
editUserDefinedAttributes: boolean;
    ...
    if (this.secWin.hasInsertPermission()) {
        createUserDefinedAttributes() {
            ...
            if(this.userDefinedAttributesForm.valid) {
                ...
                userDefinedAttributes.columnCategory = Form.getValue(this.userDefinedAttributesForm, 'columnCategory');
    ...
    updateUserDefinedAttributes(columnName : string) {
        ...
        if(this.userDefinedAttributesForm.valid) {
            ...
            userDefinedAttributes.userDefinedValidLengths = Form.getValue(this.userDefinedAttributesForm, 'validLength');
            userDefinedAttributes.userDefinedDisplayMask = Form.getValue(this.userDefinedAttributesForm, 'displayMask');
            this.userDefinedAttributesService.updateUserDefinedAttributes(userDefinedAttributes, columnName).subscribe(response => {
        ...
        if(this.editUserDefinedAttributes) {
            this.updateUserDefinedAttributes(this.userDefinedAttributes.columnName)
        } else {
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.userDefinedAttributesForm = this.formBuilder.group({
            ...
            columnName: ['', {updateOn: 'blur', validators: [] }],
            columnCategory: ['', {updateOn: 'blur', validators: [] }],
            required: ['', {updateOn: 'blur', validators: [] }],
            langaugeId: ['', {updateOn: 'blur', validators: [] }],
