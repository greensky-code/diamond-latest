...
import { BenefitRuleSelectionComponent } from './benefit-rule-selection.component';
...
describe('BenefitRuleSelectionComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with BenefitRuleSelectionComponent setup', BenefitRuleSelectionComponentSetup);
...
let de: DebugElement;
let comp: BenefitRuleSelectionComponent;
let fixture: ComponentFixture<BenefitRuleSelectionComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(BenefitRuleSelectionComponent);
...
function BenefitRuleSelectionComponentSetup() {
    describe('BenefitRuleSelectionComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [BenefitRuleSelectionComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('BenefitRuleSelectionComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(BenefitRuleSelectionComponent, {
                set: {
                    providers: [
