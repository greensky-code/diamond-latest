...
describe('ClaimHoldRulesComponent', () => {
    ...
    describe('with ClaimHoldRulesComponent setup', ClaimHoldRulesComponentSetup);
...
let de: DebugElement;
let comp: ClaimHoldRulesComponent;
...
function ClaimHoldRulesComponentSetup() {
    describe('ClaimHoldRulesComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('ClaimHoldRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimHoldRulesComponent, {
                set: {
                    providers: [
