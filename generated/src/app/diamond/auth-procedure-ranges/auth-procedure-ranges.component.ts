...
import {  AuthProcedureRangeValue } from "../../api-models/index"
import {  AuthProcedureRangeValueService } from "../../api-services/auth-procedure-range-value.service"
import {  AuthProcedureRange } from "../../api-models/index"
import {  AuthProcedureRangeService } from "../../api-services/auth-procedure-range.service"
...
editAuthProcedureRangeValue: boolean;
    ...
    authProcedureRangeValues: AuthProcedureRangeValue[];editAuthProcedureRange: boolean;
    ...
    updateAuthProcedureRangeValue(authProcRangeId : string) {
        ...
        if(this.authProcedureRangesForm.valid) {
            let authProcedureRangeValue = new AuthProcedureRangeValue();
            authProcedureRangeValue.authProcRangeId = Form.getValue(this.authProcedureRangesForm, 'authProcRangeId');
            this.authProcedureRangeValueService.updateAuthProcedureRangeValue(authProcedureRangeValue, authProcRangeId).subscribe(response => {
    ...
    private securityService: SecurityService,
     private authProcedureRangeValueService: AuthProcedureRangeValueService, private authProcedureRangeService: AuthProcedureRangeService) {
    }
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.authProcedureRangesForm = this.formBuilder.group({
            authProcRangeId: ['', {updateOn: 'blur', validators: [Validators.required,Validators.maxLength(5)] }],
            description: ['', {updateOn: 'blur', validators: [Validators.maxLength(60)] }]
        }, {updateOn: 'submit'});
    }
