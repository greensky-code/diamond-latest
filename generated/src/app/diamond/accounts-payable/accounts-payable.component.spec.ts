...
describe('AccountsPayableComponent', () => {
    ...
    describe('with AccountsPayableComponent setup', AccountsPayableComponentSetup);
...
let de: DebugElement;
let comp: AccountsPayableComponent;
...
function AccountsPayableComponentSetup() {
    describe('AccountsPayableComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('AccountsPayableComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AccountsPayableComponent, {
                set: {
                    providers: [
