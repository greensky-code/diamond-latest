...
export class MedicalDefinitionsComponent implements OnInit  {
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.medicalDefinitionsForm = this.formBuilder.group({
            ...
            medDefCodeTbNonMedicalF: ['', {updateOn: 'blur', validators: [] }],
            order: ['', {updateOn: 'blur', validators: [] }],
            searchSequence: ['', {updateOn: 'blur', validators: [] }],
            determTable: ['', {updateOn: 'blur', validators: [] }],
