...
import { MedicalDefinitionsComponent } from './medical-definitions.component';
...
describe('MedicalDefinitionsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with MedicalDefinitionsComponent setup', MedicalDefinitionsComponentSetup);
...
let de: DebugElement;
let comp: MedicalDefinitionsComponent;
let fixture: ComponentFixture<MedicalDefinitionsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(MedicalDefinitionsComponent);
...
function MedicalDefinitionsComponentSetup() {
    describe('MedicalDefinitionsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MedicalDefinitionsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MedicalDefinitionsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MedicalDefinitionsComponent, {
                set: {
                    providers: [
