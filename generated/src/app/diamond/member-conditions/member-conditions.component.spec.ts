...
import { MemberConditionsComponent } from './member-conditions.component';
...
describe('MemberConditionsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with MemberConditionsComponent setup', MemberConditionsComponentSetup);
...
let de: DebugElement;
let comp: MemberConditionsComponent;
let fixture: ComponentFixture<MemberConditionsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(MemberConditionsComponent);
...
function MemberConditionsComponentSetup() {
    describe('MemberConditionsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MemberConditionsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MemberConditionsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MemberConditionsComponent, {
                set: {
                    providers: [
