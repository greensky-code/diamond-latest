...
import { ScreenMaintenanceComponent } from './screen-maintenance.component';
...
describe('ScreenMaintenanceComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ScreenMaintenanceComponent setup', ScreenMaintenanceComponentSetup);
...
let de: DebugElement;
let comp: ScreenMaintenanceComponent;
let fixture: ComponentFixture<ScreenMaintenanceComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ScreenMaintenanceComponent);
...
function ScreenMaintenanceComponentSetup() {
    describe('ScreenMaintenanceComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ScreenMaintenanceComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ScreenMaintenanceComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ScreenMaintenanceComponent, {
                set: {
                    providers: [
