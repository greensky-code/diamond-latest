...
describe('FunctionAccessComponent', () => {
    ...
    describe('with FunctionAccessComponent setup', FunctionAccessComponentSetup);
...
let de: DebugElement;
let comp: FunctionAccessComponent;
...
function FunctionAccessComponentSetup() {
    describe('FunctionAccessComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('FunctionAccessComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(FunctionAccessComponent, {
                set: {
                    providers: [
