...
import { AlternaeteSearchOrderComponent } from './alternaete-search-order.component';
...
describe('AlternaeteSearchOrderComponent', () => {
    ...
    describe('with AlternaeteSearchOrderComponent setup', AlternaeteSearchOrderComponentSetup);
...
let de: DebugElement;
let comp: AlternaeteSearchOrderComponent;
let fixture: ComponentFixture<AlternaeteSearchOrderComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AlternaeteSearchOrderComponent);
    ...
    describe('AlternaeteSearchOrderComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AlternaeteSearchOrderComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AlternaeteSearchOrderComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AlternaeteSearchOrderComponent, {
                set: {
                    providers: [
