...
import { LobPreExistingConditionsComponent } from './lob-pre--existing-conditions.component';
...
describe('LobPreExistingConditionsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with LobPreExistingConditionsComponent setup', LobPreExistingConditionsComponentSetup);
...
let de: DebugElement;
let comp: LobPreExistingConditionsComponent;
let fixture: ComponentFixture<LobPreExistingConditionsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(LobPreExistingConditionsComponent);
...
function LobPreExistingConditionsComponentSetup() {
    describe('LobPreExistingConditionsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [LobPreExistingConditionsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('LobPreExistingConditionsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(LobPreExistingConditionsComponent, {
                set: {
                    providers: [
