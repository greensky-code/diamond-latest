...
describe('ProviderRelationshipComponent', () => {
    ...
    describe('with ProviderRelationshipComponent setup', ProviderRelationshipComponentSetup);
...
let de: DebugElement;
let comp: ProviderRelationshipComponent;
...
function ProviderRelationshipComponentSetup() {
    describe('ProviderRelationshipComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('ProviderRelationshipComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ProviderRelationshipComponent, {
                set: {
                    providers: [
