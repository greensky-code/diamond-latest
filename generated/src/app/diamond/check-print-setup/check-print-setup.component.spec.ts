...
import { CheckPrintSetupComponent } from './check-print-setup.component';
...
describe('CheckPrintSetupComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with CheckPrintSetupComponent setup', CheckPrintSetupComponentSetup);
...
let de: DebugElement;
let comp: CheckPrintSetupComponent;
let fixture: ComponentFixture<CheckPrintSetupComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(CheckPrintSetupComponent);
...
function CheckPrintSetupComponentSetup() {
    describe('CheckPrintSetupComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CheckPrintSetupComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('CheckPrintSetupComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(CheckPrintSetupComponent, {
                set: {
                    providers: [
