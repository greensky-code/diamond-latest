...
import {  PriceScheduleMaster } from "../../api-models/index"
import {  PriceScheduleMasterService } from "../../api-services/price-schedule-master.service"
import { AlertMessage, AlertMessageService } from '../../shared/components/alert-message/index'
import { SecWinService } from '../../../api-services/security/sec-win.service';

// Use the Component directive to define the PriceScheduleComponent as an Angular component
//
...
editPriceScheduleMaster: boolean;
        ...
        createPriceScheduleMaster() {
            ...
            if(this.priceScheduleForm.valid) {
                ...
                this.priceScheduleMasterService.createPriceScheduleMaster(priceScheduleMaster).subscribe(response => {
                    ...
                    this.editPriceScheduleMaster = false;
                }, error => {
    ...
    }    deletePriceScheduleMaster(priceSchedule : string) {
        if (!(this.secWin && this.secWin.hasDeletePermission())) {
            this.showPopUp('Not permitted to delete', 'Group Master Security');
        } else {
            this.priceScheduleMasterService.deletePriceScheduleMaster(priceSchedule).subscribe(response => {
                this.alertMessage = this.alertMessageService.info("Record successfully deleted.");
            }, error => {
                this.alertMessage = this.alertMessageService.error("An Error occurred while deleting record.");
            });
       }
    }    getPriceScheduleMaster(priceSchedule : string) {
        this.priceScheduleMasterService.getPriceScheduleMaster(priceSchedule).subscribe(priceScheduleMaster => {
            this.priceScheduleMaster = priceScheduleMaster;
            this.priceScheduleForm.patchValue({
                'scheduleId': this.priceScheduleMaster.priceSchedule,
                'description': this.priceScheduleMaster.description,
            });
        }, error => {
