...
describe('PriceScheduleComponent', () => {
    ...
    describe('with PriceScheduleComponent setup', PriceScheduleComponentSetup);
...
let de: DebugElement;
let comp: PriceScheduleComponent;
...
function PriceScheduleComponentSetup() {
    describe('PriceScheduleComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('PriceScheduleComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PriceScheduleComponent, {
                set: {
                    providers: [
