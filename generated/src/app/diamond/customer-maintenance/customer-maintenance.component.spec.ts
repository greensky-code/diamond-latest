...
describe('CustomerMaintenanceComponent', () => {
    ...
    describe('with CustomerMaintenanceComponent setup', CustomerMaintenanceComponentSetup);
...
let de: DebugElement;
let comp: CustomerMaintenanceComponent;
...
function CustomerMaintenanceComponentSetup() {
...
function formsModuleSetup() {
    ...
    describe('CustomerMaintenanceComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(CustomerMaintenanceComponent, {
                set: {
                    providers: [
