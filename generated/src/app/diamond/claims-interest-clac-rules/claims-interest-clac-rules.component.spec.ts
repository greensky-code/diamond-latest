...
import { ClaimsInterestClacRulesComponent } from './claims-interest-clac-rules.component';
...
describe('ClaimsInterestClacRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimsInterestClacRulesComponent setup', ClaimsInterestClacRulesComponentSetup);
...
let de: DebugElement;
let comp: ClaimsInterestClacRulesComponent;
let fixture: ComponentFixture<ClaimsInterestClacRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimsInterestClacRulesComponent);
...
function ClaimsInterestClacRulesComponentSetup() {
    describe('ClaimsInterestClacRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimsInterestClacRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimsInterestClacRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimsInterestClacRulesComponent, {
                set: {
                    providers: [
