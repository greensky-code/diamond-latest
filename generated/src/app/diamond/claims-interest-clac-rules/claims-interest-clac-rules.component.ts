...
// Use the Component directive to define the ClaimsInterestClacRulesComponent as an Angular component
//
...
@Component({
    ...
    selector: 'claimsinterestclacrules',
    templateUrl: './claims-interest-clac-rules.component.html',

})
export class ClaimsInterestClacRulesComponent implements OnInit  {

    // The form model used by the view per Angular Reactive Forms
    // See: https://angular.io/docs/ts/latest/guide/reactive-forms.html#!#intro
    claimsInterestClacRulesForm: FormGroup;
    ...
    ngOnInit(): void {
        ...
        this.createForm();
        this.displayMessage = {};
        this.formValidation = new FormValidation(this.claimsInterestClacRulesForm);
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.claimsInterestClacRulesForm = this.formBuilder.group({
            lineOfBusinessLb: ['', {updateOn: 'blur', validators: [] }],
            claimTypeTbrule: ['', {updateOn: 'blur', validators: [] }],
            effectiveDateDt: ['', {updateOn: 'blur', validators: [] }],
            description: ['', {updateOn: 'blur', validators: [] }],
            pct: ['', {updateOn: 'blur', validators: [] }],
            calcMethodTbinterest: ['', {updateOn: 'blur', validators: [] }],
            ...
            minPayableIntrlineTb: ['', {updateOn: 'blur', validators: [] }],
            graceDays: ['', {updateOn: 'blur', validators: [] }],
            minPayableIntrclaim: ['', {updateOn: 'blur', validators: [] }],
            excelUncleanClaimLine: ['', {updateOn: 'blur', validators: [] }],
