...
import { MemberClaimHoldCodesComponent } from './member-claim-hold-codes.component';
...
describe('MemberClaimHoldCodesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with MemberClaimHoldCodesComponent setup', MemberClaimHoldCodesComponentSetup);
...
let de: DebugElement;
let comp: MemberClaimHoldCodesComponent;
let fixture: ComponentFixture<MemberClaimHoldCodesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(MemberClaimHoldCodesComponent);
...
function MemberClaimHoldCodesComponentSetup() {
    describe('MemberClaimHoldCodesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MemberClaimHoldCodesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MemberClaimHoldCodesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MemberClaimHoldCodesComponent, {
                set: {
                    providers: [
