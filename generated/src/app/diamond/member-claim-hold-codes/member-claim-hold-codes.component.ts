...
editMemberMaster: boolean;
    ...
    createMemberMaster() {
        ...
        if(this.memberClaimHoldCodesForm.valid) {
            ...
            memberMaster.holdReason = Form.getValue(this.this.memberClaimHoldCodesForm, 'claimHoldCode');
            memberMaster.holdDate = Form.getValue(this.this.memberClaimHoldCodesForm, 'claimHoldDate');
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.memberClaimHoldCodesForm = this.formBuilder.group({
            claimHoldCode: ['', {updateOn: 'blur', validators: [] }],
