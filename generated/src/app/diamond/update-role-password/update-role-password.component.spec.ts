...
import { UpdateRolePasswordComponent } from './update-role-password.component';
...
describe('UpdateRolePasswordComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with UpdateRolePasswordComponent setup', UpdateRolePasswordComponentSetup);
...
let de: DebugElement;
let comp: UpdateRolePasswordComponent;
let fixture: ComponentFixture<UpdateRolePasswordComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(UpdateRolePasswordComponent);
...
function UpdateRolePasswordComponentSetup() {
    describe('UpdateRolePasswordComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [UpdateRolePasswordComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('UpdateRolePasswordComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(UpdateRolePasswordComponent, {
                set: {
                    providers: [
