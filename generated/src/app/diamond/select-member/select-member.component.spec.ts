...
describe('SelectMemberComponent', () => {
    ...
    describe('with SelectMemberComponent setup', SelectMemberComponentSetup);
...
let de: DebugElement;
let comp: SelectMemberComponent;
...
function SelectMemberComponentSetup() {
    describe('SelectMemberComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('SelectMemberComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(SelectMemberComponent, {
                set: {
                    providers: [
