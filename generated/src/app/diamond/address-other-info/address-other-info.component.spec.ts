...
import { AddressOtherInfoComponent } from './address-other-info.component';
...
describe('AddressOtherInfoComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AddressOtherInfoComponent setup', AddressOtherInfoComponentSetup);
...
let de: DebugElement;
let comp: AddressOtherInfoComponent;
let fixture: ComponentFixture<AddressOtherInfoComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AddressOtherInfoComponent);
...
function AddressOtherInfoComponentSetup() {
    describe('AddressOtherInfoComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AddressOtherInfoComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AddressOtherInfoComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AddressOtherInfoComponent, {
                set: {
                    providers: [
