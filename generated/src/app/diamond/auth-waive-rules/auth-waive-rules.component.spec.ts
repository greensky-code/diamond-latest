...
import { AuthWaiveRulesComponent } from './auth-waive-rules.component';
...
describe('AuthWaiveRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AuthWaiveRulesComponent setup', AuthWaiveRulesComponentSetup);
...
let de: DebugElement;
let comp: AuthWaiveRulesComponent;
let fixture: ComponentFixture<AuthWaiveRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AuthWaiveRulesComponent);
...
function AuthWaiveRulesComponentSetup() {
    describe('AuthWaiveRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AuthWaiveRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AuthWaiveRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthWaiveRulesComponent, {
                set: {
                    providers: [
