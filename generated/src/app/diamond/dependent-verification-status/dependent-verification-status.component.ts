...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.dependentVerificationStatusForm = this.formBuilder.group({
            dependentStatus: ['', {updateOn: 'blur', validators: [] }],
            studentStatusDetailCode: ['', {updateOn: 'blur', validators: [] }],
            verifiedThruDate: ['', {updateOn: 'blur', validators: [] }],
            usrDef1: ['', {updateOn: 'blur', validators: [] }],
            usrDat1: ['', {updateOn: 'blur', validators: [] }],
            usrDef2: ['', {updateOn: 'blur', validators: [] }],
