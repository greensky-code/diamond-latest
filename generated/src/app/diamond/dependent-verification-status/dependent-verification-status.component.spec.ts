...
import { DependentVerificationStatusComponent } from './dependent-verification-status.component';
...
describe('DependentVerificationStatusComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with DependentVerificationStatusComponent setup', DependentVerificationStatusComponentSetup);
...
let de: DebugElement;
let comp: DependentVerificationStatusComponent;
let fixture: ComponentFixture<DependentVerificationStatusComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(DependentVerificationStatusComponent);
...
function DependentVerificationStatusComponentSetup() {
    describe('DependentVerificationStatusComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [DependentVerificationStatusComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('DependentVerificationStatusComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(DependentVerificationStatusComponent, {
                set: {
                    providers: [
