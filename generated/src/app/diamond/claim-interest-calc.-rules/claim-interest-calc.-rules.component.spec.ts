...
import { ClaimInterestCalcRulesComponent } from './claim-interest-calc.-rules.component';
...
describe('ClaimInterestCalcRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimInterestCalcRulesComponent setup', ClaimInterestCalcRulesComponentSetup);
...
let de: DebugElement;
let comp: ClaimInterestCalcRulesComponent;
let fixture: ComponentFixture<ClaimInterestCalcRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimInterestCalcRulesComponent);
...
function ClaimInterestCalcRulesComponentSetup() {
    describe('ClaimInterestCalcRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimInterestCalcRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimInterestCalcRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimInterestCalcRulesComponent, {
                set: {
                    providers: [
