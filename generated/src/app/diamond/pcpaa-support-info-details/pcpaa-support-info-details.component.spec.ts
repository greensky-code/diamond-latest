...
import { PcpaaSupportInfoDetailsComponent } from './pcpaa-support-info-details.component';
...
describe('PcpaaSupportInfoDetailsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PcpaaSupportInfoDetailsComponent setup', PcpaaSupportInfoDetailsComponentSetup);
...
let de: DebugElement;
let comp: PcpaaSupportInfoDetailsComponent;
let fixture: ComponentFixture<PcpaaSupportInfoDetailsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(PcpaaSupportInfoDetailsComponent);
...
function PcpaaSupportInfoDetailsComponentSetup() {
    describe('PcpaaSupportInfoDetailsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PcpaaSupportInfoDetailsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('PcpaaSupportInfoDetailsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PcpaaSupportInfoDetailsComponent, {
                set: {
                    providers: [
