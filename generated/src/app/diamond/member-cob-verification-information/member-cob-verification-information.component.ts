...
export class MemberCobVerificationInformationComponent implements OnInit  {

    // The form model used by the view per Angular Reactive Forms
    // See: https://angular.io/docs/ts/latest/guide/reactive-forms.html#!#intro
    memberCobVerificationInformationForm: FormGroup;
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.memberCobVerificationInformationForm = this.formBuilder.group({
            verificationDate: ['', {updateOn: 'blur', validators: [] }],
