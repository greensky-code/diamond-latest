...
import {  AuthCode } from "../../api-models/index"
...
editAuthCode: boolean;
    ...
    updateAuthCode(authCode : string) {
        if (this.secWin && this.secWin.hasUpdatePermission()) {
        this.formValidation.validateForm();
        if(this.authorizationCodeForm.valid) {
            let authCode = new AuthCode();
            this.authCodeService.updateAuthCode(authCode, authCode).subscribe(response => {
        ...
        if(this.editAuthCode) {
            this.updateAuthCode(this.authCode.authCode)
        } else {
            this.createAuthCode();
        }
        ...
        if (!(this.secWin && this.secWin.hasDeletePermission())) {
            ...
            this.authCodeService.deleteAuthCode(authCode).subscribe(response => {
        ...
        this.authCodeService.getAuthCode(authCode).subscribe(authCode => {
        ...
        this.authCodeService.getAuthCodes().subscribe(authCodes => {
