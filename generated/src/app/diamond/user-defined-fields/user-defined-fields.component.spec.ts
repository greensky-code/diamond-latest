...
describe('UserDefinedFieldsComponent', () => {
    ...
    describe('with UserDefinedFieldsComponent setup', UserDefinedFieldsComponentSetup);
...
let de: DebugElement;
let comp: UserDefinedFieldsComponent;
...
function UserDefinedFieldsComponentSetup() {
    describe('UserDefinedFieldsComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('UserDefinedFieldsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(UserDefinedFieldsComponent, {
                set: {
                    providers: [
