...
import {  CheckClearVoidSetup } from "../../api-models/index"
import {  CheckClearVoidSetupService } from "../../api-services/check-clear-void-setup.service"
...
editCheckClearVoidSetup: boolean;
    ...
    updateCheckClearVoidSetup(jobId : string) {
        ...
        this.checkClearVoidSetupService.getCheckClearVoidSetups().subscribe(checkClearVoidSetups => {
        this.checkClearVoidSetups = checkClearVoidSetups;
        }, error => {
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.clearVoidStopUpdateForm = this.formBuilder.group({
            ...
            radiobuttongroup2650: ['', {updateOn: 'blur', validators: [] }],
