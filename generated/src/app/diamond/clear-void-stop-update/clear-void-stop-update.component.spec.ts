...
import { ClearVoidStopUpdateComponent } from './clear-void-stop-update.component';
...
describe('ClearVoidStopUpdateComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClearVoidStopUpdateComponent setup', ClearVoidStopUpdateComponentSetup);
...
let de: DebugElement;
let comp: ClearVoidStopUpdateComponent;
let fixture: ComponentFixture<ClearVoidStopUpdateComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClearVoidStopUpdateComponent);
...
function ClearVoidStopUpdateComponentSetup() {
    describe('ClearVoidStopUpdateComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClearVoidStopUpdateComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClearVoidStopUpdateComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClearVoidStopUpdateComponent, {
                set: {
                    providers: [
