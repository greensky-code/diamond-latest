...
import { AuthClaimMatchRulesComponent } from './auth-claim-match-rules.component';
...
describe('AuthClaimMatchRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AuthClaimMatchRulesComponent setup', AuthClaimMatchRulesComponentSetup);
...
let de: DebugElement;
let comp: AuthClaimMatchRulesComponent;
let fixture: ComponentFixture<AuthClaimMatchRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AuthClaimMatchRulesComponent);
...
function AuthClaimMatchRulesComponentSetup() {
    describe('AuthClaimMatchRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AuthClaimMatchRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AuthClaimMatchRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthClaimMatchRulesComponent, {
                set: {
                    providers: [
