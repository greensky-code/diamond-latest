...
import {  NoteType } from "../../api-models/index"
import {  NoteTypeService } from "../../api-services/note-type.service"
...
editNoteType: boolean;
    ...
    updateNoteType(noteType : string) {
        ...
        if(this.noteTypeForm.valid) {
            ...
            noteType.priority = Form.getValue(this.noteTypeForm, 'priority');
            noteType.description = Form.getValue(this.noteTypeForm, 'description');
            this.noteTypeService.updateNoteType(noteType, noteType).subscribe(response => {
        ...
        if(this.editNoteType) {
            this.updateNoteType(this.noteType.noteType)
        } else {
            this.createNoteType();
        }
    }    deleteNoteType(noteType : string) {
        if (!(this.secWin && this.secWin.hasDeletePermission())) {
            this.showPopUp('Not permitted to delete', 'Group Master Security');
        } else {
            this.noteTypeService.deleteNoteType(noteType).subscribe(response => {
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.noteTypeForm = this.formBuilder.group({
            noteType: ['', {updateOn: 'blur', validators: [] }],
            priority: ['', {updateOn: 'blur', validators: [] }],
