...
describe('NoteTypeComponent', () => {
    ...
    describe('with NoteTypeComponent setup', NoteTypeComponentSetup);
...
function NoteTypeComponentSetup() {
    describe('NoteTypeComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('NoteTypeComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(NoteTypeComponent, {
                set: {
                    providers: [
