...
import { ConversionFactorTypeComponent } from './conversion-factor-type.component';
...
describe('ConversionFactorTypeComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ConversionFactorTypeComponent setup', ConversionFactorTypeComponentSetup);
...
let de: DebugElement;
let comp: ConversionFactorTypeComponent;
let fixture: ComponentFixture<ConversionFactorTypeComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ConversionFactorTypeComponent);
...
function ConversionFactorTypeComponentSetup() {
    describe('ConversionFactorTypeComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ConversionFactorTypeComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ConversionFactorTypeComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ConversionFactorTypeComponent, {
                set: {
                    providers: [
