...
import {  ProcedureDeterminant } from "../../api-models/index"
...
editProcedureDeterminant: boolean;
    ...
    if (this.secWin.hasInsertPermission()) {
        createProcedureDeterminant() {
            ...
            if(this.procedureDeterminantForm.valid) {
                ...
                procedureDeterminant.procedureCode = Form.getValue(this.procedureDeterminantForm, 'procedureCode');
                this.procedureDeterminantService.createProcedureDeterminant(procedureDeterminant).subscribe(response => {
    ...
    updateProcedureDeterminant(procedureCode : string) {
        ...
        if(this.procedureDeterminantForm.valid) {
            let procedureDeterminant = new ProcedureDeterminant();
            procedureDeterminant.procedureCode = Form.getValue(this.procedureDeterminantForm, 'procedureCode');
            this.procedureDeterminantService.updateProcedureDeterminant(procedureDeterminant, procedureCode).subscribe(response => {
        ...
        if (!(this.secWin && this.secWin.hasDeletePermission())) {
            ...
            this.procedureDeterminantService.deleteProcedureDeterminant(procedureCode).subscribe(response => {
        ...
        this.procedureDeterminantService.getProcedureDeterminant(procedureCode).subscribe(procedureDeterminant => {
            this.procedureDeterminant = procedureDeterminant;
            this.procedureDeterminantForm.patchValue({
                'procedureCode': this.procedureDeterminant.procedureCode,
            });
        }, error => {
            this.alertMessage = this.alertMessageService.error("An Error occurred while retrieving record.");
        });
    }    getProcedureDeterminants() {
        this.procedureDeterminantService.getProcedureDeterminants().subscribe(procedureDeterminants => {
