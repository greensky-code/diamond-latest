...
import {  FinalNonApSetup } from "../../api-models/index"
...
editFinalNonApSetup: boolean;
    ...
    }    deleteFinalNonApSetup(jobId : string) {
        if (!(this.secWin && this.secWin.hasDeletePermission())) {
            this.showPopUp('Not permitted to delete', 'Group Master Security');
        } else {
            this.finalNonApSetupService.deleteFinalNonApSetup(jobId).subscribe(response => {
