...
export class BenefitPackageComponent implements OnInit  {
...
editBenefitPackageDetail: boolean;
    ...
    createBenefitPackageDetail() {
        ...
        if(this.benefitPackageForm.valid) {
            ...
            benefitPackageDetail.processingOrder = Form.getValue(this.this.benefitPackageForm, 'processingOrderId');
            benefitPackageDetail.applyPar = Form.getValue(this.this.benefitPackageForm, 'applyPatLiabilityTo');
            benefitPackageDetail.startDate = Form.getValue(this.this.benefitPackageForm, 'narrative');
            benefitPackageDetail.authReq = Form.getValue(this.this.benefitPackageForm, 'authReq');
            benefitPackageDetail.adjustForOcPaid = Form.getValue(this.this.benefitPackageForm, 'adjustForOcPd');
            benefitPackageDetail.noMosContThru = Form.getValue(this.this.benefitPackageForm, 'fromMonthsTbThruMonths');
    ...
    updateBenefitPackageDetail(benefitPackageId : string) {
        ...
        this.benefitPackageDetailService.getBenefitPackageDetail(benefitPackageId).subscribe(benefitPackageDetail => {
            ...
            this.benefitPackageForm.patchValue({
                'processingOrderId': this.benefitPackageDetail.processingOrder,
                'applyPatLiabilityTo': this.benefitPackageDetail.applyPar,
                'narrative': this.dateFormatPipe.defaultDisplayDateFormat(this.benefitPackageDetail.startDate),
                'authReq': this.benefitPackageDetail.authReq,
                'adjustForOcPd': this.benefitPackageDetail.adjustForOcPaid,
                'fromMonthsTbThruMonths': this.benefitPackageDetail.noMosContThru,
            });
        }, error => {
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.benefitPackageForm = this.formBuilder.group({
            ...
            processingOrderId: ['', {updateOn: 'blur', validators: [] }],
            applyPatLiabilityTo: ['', {updateOn: 'blur', validators: [] }],
            ...
            applyWuthLevelTbApplyPar: ['', {updateOn: 'blur', validators: [] }],
            adjustForOcPd: ['', {updateOn: 'blur', validators: [] }],
            fromMonthsTbThruMonths: ['', {updateOn: 'blur', validators: [] }],
