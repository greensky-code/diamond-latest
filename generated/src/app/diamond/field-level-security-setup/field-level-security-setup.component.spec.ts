...
import { FieldLevelSecuritySetupComponent } from './field-level-security-setup.component';
...
describe('FieldLevelSecuritySetupComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with FieldLevelSecuritySetupComponent setup', FieldLevelSecuritySetupComponentSetup);
...
let de: DebugElement;
let comp: FieldLevelSecuritySetupComponent;
let fixture: ComponentFixture<FieldLevelSecuritySetupComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(FieldLevelSecuritySetupComponent);
...
function FieldLevelSecuritySetupComponentSetup() {
    describe('FieldLevelSecuritySetupComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [FieldLevelSecuritySetupComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('FieldLevelSecuritySetupComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(FieldLevelSecuritySetupComponent, {
                set: {
                    providers: [
