...
/**
 * Declares all of the components that are used inside the AP feature module
 * and provides any services for the AP feature module.
 *
 ...
 */
import { ApRoutingModule, apRoutedComponents }  from './ap-routing.module';
...
@NgModule({
  imports: [
    ...
    declarations: [ apRoutedComponents ]
})
