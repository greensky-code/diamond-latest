...
import {  ArAdjustment } from "../../api-models/index"
    ...
    if (this.secWin.hasInsertPermission()) {
        createArAdjustment() {
            ...
            if(this.arAdjustmentsForm.valid) {
                ...
                arAdjustment.customerId = Form.getValue(this.arAdjustmentsForm, 'arAdjustmentId');
                arAdjustment.customerType = Form.getValue(this.arAdjustmentsForm, 'customerType');
                arAdjustment.seqAradjId = Form.getValue(this.arAdjustmentsForm, 'customerId');
                arAdjustment.transDate = Form.getValue(this.arAdjustmentsForm, 'transactionDate');
                arAdjustment.transAmt = Form.getValue(this.arAdjustmentsForm, 'transactionAmt');
                arAdjustment.glRefCode = Form.getValue(this.arAdjustmentsForm, 'reasonCode');
    ...
    updateArAdjustment(seqAradjId : number) {
        ...
        this.arAdjustmentService.getArAdjustment(seqAradjId).subscribe(arAdjustment => {
            ...
            this.arAdjustmentsForm.patchValue({
                'arAdjustmentId': this.arAdjustment.customerId,
                'customerType': this.arAdjustment.customerType,
                'customerId': this.arAdjustment.seqAradjId,
                ...
                'reasonCode': this.arAdjustment.glRefCode,
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.arAdjustmentsForm = this.formBuilder.group({
            arAdjustmentId: ['', {updateOn: 'blur', validators: [] }],
