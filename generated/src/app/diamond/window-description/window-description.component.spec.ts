...
import { WindowDescriptionComponent } from './window-description.component';
...
describe('WindowDescriptionComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with WindowDescriptionComponent setup', WindowDescriptionComponentSetup);
...
let de: DebugElement;
let comp: WindowDescriptionComponent;
let fixture: ComponentFixture<WindowDescriptionComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(WindowDescriptionComponent);
...
function WindowDescriptionComponentSetup() {
    describe('WindowDescriptionComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [WindowDescriptionComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('WindowDescriptionComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(WindowDescriptionComponent, {
                set: {
                    providers: [
