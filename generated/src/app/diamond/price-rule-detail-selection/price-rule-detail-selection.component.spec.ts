...
import { PriceRuleDetailSelectionComponent } from './price-rule-detail-selection.component';
...
describe('PriceRuleDetailSelectionComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PriceRuleDetailSelectionComponent setup', PriceRuleDetailSelectionComponentSetup);
...
let de: DebugElement;
let comp: PriceRuleDetailSelectionComponent;
let fixture: ComponentFixture<PriceRuleDetailSelectionComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(PriceRuleDetailSelectionComponent);
...
function PriceRuleDetailSelectionComponentSetup() {
    describe('PriceRuleDetailSelectionComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PriceRuleDetailSelectionComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('PriceRuleDetailSelectionComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PriceRuleDetailSelectionComponent, {
                set: {
                    providers: [
