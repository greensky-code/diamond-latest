    ...
    if (this.secWin.hasInsertPermission()) {
        createAuthMaster() {
            ...
            if(this.authorizationMasterForm.valid) {
                ...
                authMaster.authNumber = Form.getValue(this.authorizationMasterForm, 'authNumber');
                authMaster.requestedDate = Form.getValue(this.authorizationMasterForm, 'reqDate');
                authMaster.authType = Form.getValue(this.authorizationMasterForm, 'authType');
                authMaster.authLevel = Form.getValue(this.authorizationMasterForm, 'leverl');
                authMaster.tplCode = Form.getValue(this.authorizationMasterForm, 'tplCode');
                authMaster.privacyApplied = Form.getValue(this.authorizationMasterForm, 'privacyMaApply');
                authMaster.memberAge = Form.getValue(this.authorizationMasterForm, 'memberId');
                authMaster.seqGroupId = Form.getValue(this.authorizationMasterForm, 'groupId');
                authMaster.planCode = Form.getValue(this.authorizationMasterForm, 'planCode');
                authMaster.nsSubscriberId = Form.getValue(this.authorizationMasterForm, 'nonSysSubscriberId');
                authMaster.certificationType = Form.getValue(this.authorizationMasterForm, 'certificationType');
                authMaster.paperworkAttached = Form.getValue(this.authorizationMasterForm, 'paperworkAttachment');
                authMaster.intakeDateTime = Form.getValue(this.authorizationMasterForm, 'intakeDateTime');
                authMaster.callerName = Form.getValue(this.authorizationMasterForm, 'callerName');
                authMaster.callerPhoneNumber = Form.getValue(this.authorizationMasterForm, 'callerPhoneNo');
                authMaster.patientAcctNo = Form.getValue(this.authorizationMasterForm, 'patientAcctNo');
                authMaster.medicalRecNo = Form.getValue(this.authorizationMasterForm, 'medicalRecNo');
                authMaster.diagnosisNarrative = Form.getValue(this.authorizationMasterForm, 'dxNarrative');
                authMaster.surgicalProcedureNarrative = Form.getValue(this.authorizationMasterForm, 'spNarrative');
                authMaster.relatedCauseCode = Form.getValue(this.authorizationMasterForm, 'caCase');
                authMaster.datesUserDefined2 = Form.getValue(this.authorizationMasterForm, 'userDefined2');
                authMaster.datesUserDefinedDate = Form.getValue(this.authorizationMasterForm, 'userDefinedDate');
    ...
    updateAuthMaster(secondaryAuthNo : string) {
        ...
        this.authMasterService.getAuthMaster(secondaryAuthNo).subscribe(authMaster => {
            ...
            this.authorizationMasterForm.patchValue({
                ...
                'intakeDateTime': this.dateFormatPipe.defaultDisplayDateFormat(this.authMaster.intakeDateTime),
                ...
                'userDefinedDate': this.dateFormatPipe.defaultDisplayDateFormat(this.authMaster.datesUserDefinedDate),
            });
        }, error => {
