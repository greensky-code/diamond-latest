...
import {  GroupPanel } from "../../api-models/index"
...
editGroupPanel: boolean;
    ...
    createGroupPanel() {
        ...
        if(this.groupPanelForm.valid) {
            ...
            this.groupPanelService.createGroupPanel(groupPanel).subscribe(response => {
    ...
    updateGroupPanel(seqGroupPanel : number) {
        ...
        if(this.groupPanelForm.valid) {
            let groupPanel = new GroupPanel();
            this.groupPanelService.updateGroupPanel(groupPanel, seqGroupPanel).subscribe(response => {
        ...
        if(this.editGroupPanel) {
            this.updateGroupPanel(this.groupPanel.seqGroupPanel)
        } else {
            this.createGroupPanel();
        }
    }    deleteGroupPanel(seqGroupPanel : number) {
        this.groupPanelService.deleteGroupPanel(seqGroupPanel).subscribe(response => {
            this.alertMessage = this.alertMessageService.info("Record successfully deleted.");
        }, error => {
            this.alertMessage = this.alertMessageService.error("An Error occurred while deleting record.");
        });
    }    getGroupPanel(seqGroupPanel : number) {
        this.groupPanelService.getGroupPanel(seqGroupPanel).subscribe(groupPanel => {
        ...
        this.groupPanelService.getGroupPanels().subscribe(groupPanels => {
