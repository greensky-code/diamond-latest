...
describe('GroupPanelComponent', () => {
    ...
    describe('with GroupPanelComponent setup', GroupPanelComponentSetup);
...
function GroupPanelComponentSetup() {
    describe('GroupPanelComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('GroupPanelComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(GroupPanelComponent, {
                set: {
                    providers: [
