...
import {  MessageMasterHdr } from "../../api-models/index"
import {  MessageMasterHdrService } from "../../api-services/message-master-hdr.service"
...
editMessageMasterHdr: boolean;
    ...
    updateMessageMasterHdr(messageId : number) {
        ...
        this.messageMasterHdrService.getMessageMasterHdr(messageId).subscribe(messageMasterHdr => {
            ...
            this.messageMaintenanceForm.patchValue({
                ...
                'uncleanIndicator': this.messageMasterHdr.uncleanFlag,
            });
        }, error => {
            this.alertMessage = this.alertMessageService.error("An Error occurred while retrieving record.");
        });
    }    getMessageMasterHdrs() {
    ...
    createDataGrid(): void {
      ...
      this.dataGridGridOptions.columnDefs = [
         ...
         {
             headerName: "Message Level",
             field: "messagelevel",
             width: 200         },
         {
             headerName: "ReplacementText",
             field: "replacementtext",
             width: 200         },
         {
             headerName: "Display Message",
             field: "displaymessage",
             width: 200         },
         {
             headerName: "Retain Message",
             field: "retainmessage",
             width: 200         }
      ];
    }
