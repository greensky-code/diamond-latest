...
import { MessageMaintenanceComponent } from './message-maintenance.component';
...
describe('MessageMaintenanceComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with MessageMaintenanceComponent setup', MessageMaintenanceComponentSetup);
...
let de: DebugElement;
let comp: MessageMaintenanceComponent;
let fixture: ComponentFixture<MessageMaintenanceComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(MessageMaintenanceComponent);
...
function MessageMaintenanceComponentSetup() {
    describe('MessageMaintenanceComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MessageMaintenanceComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MessageMaintenanceComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MessageMaintenanceComponent, {
                set: {
                    providers: [
