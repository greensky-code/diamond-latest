...
// Use the Component directive to define the MemberMasterMainComponent as an Angular component
//
...
@Component({
    ...
    selector: 'membermastermain',
    templateUrl: './member-master-main.component.html',
    providers: [        DatePipe,
        Mask,
        CustomValidators,
        DateFormatPipe,
...
export class MemberMasterMainComponent implements OnInit  {

    // The form model used by the view per Angular Reactive Forms
    // See: https://angular.io/docs/ts/latest/guide/reactive-forms.html#!#intro
    memberMasterMainForm: FormGroup;
...
editMemberMaster: boolean;
    ...
    createMemberMaster() {
        ...
        if(this.memberMasterMainForm.valid) {
            let memberMaster = new MemberMaster();
            memberMaster.diamondId = Form.getValue(this.this.memberMasterMainForm, 'diamondId');
            memberMaster.subscriberId = Form.getValue(this.this.memberMasterMainForm, 'subscriberId');
    ...
    updateMemberMaster(seqMembId : number) {
        ...
        this.memberMasterService.getMemberMaster(seqMembId).subscribe(memberMaster => {
            ...
            this.memberMasterMainForm.patchValue({
    ...
    ngOnInit(): void {
        this.createForm();
        this.displayMessage = {};
        this.formValidation = new FormValidation(this.memberMasterMainForm);
    }
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.memberMasterMainForm = this.formBuilder.group({
