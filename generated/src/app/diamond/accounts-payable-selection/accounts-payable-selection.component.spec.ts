...
import { AccountsPayableSelectionComponent } from './accounts-payable-selection.component';
...
describe('AccountsPayableSelectionComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AccountsPayableSelectionComponent setup', AccountsPayableSelectionComponentSetup);
...
let de: DebugElement;
let comp: AccountsPayableSelectionComponent;
let fixture: ComponentFixture<AccountsPayableSelectionComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AccountsPayableSelectionComponent);
...
function AccountsPayableSelectionComponentSetup() {
    describe('AccountsPayableSelectionComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AccountsPayableSelectionComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AccountsPayableSelectionComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AccountsPayableSelectionComponent, {
                set: {
                    providers: [
