...
import { DisplayBenefitAccumulatorsComponent } from './display-benefit-accumulators.component';
...
describe('DisplayBenefitAccumulatorsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with DisplayBenefitAccumulatorsComponent setup', DisplayBenefitAccumulatorsComponentSetup);
...
let de: DebugElement;
let comp: DisplayBenefitAccumulatorsComponent;
let fixture: ComponentFixture<DisplayBenefitAccumulatorsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(DisplayBenefitAccumulatorsComponent);
...
function DisplayBenefitAccumulatorsComponentSetup() {
    describe('DisplayBenefitAccumulatorsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [DisplayBenefitAccumulatorsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('DisplayBenefitAccumulatorsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(DisplayBenefitAccumulatorsComponent, {
                set: {
                    providers: [
