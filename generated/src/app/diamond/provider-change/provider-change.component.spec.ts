...
describe('ProviderChangeComponent', () => {
    ...
    describe('with ProviderChangeComponent setup', ProviderChangeComponentSetup);
...
let de: DebugElement;
let comp: ProviderChangeComponent;
...
function ProviderChangeComponentSetup() {
    describe('ProviderChangeComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('ProviderChangeComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ProviderChangeComponent, {
                set: {
                    providers: [
