...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.vendorCreditStatusForm = this.formBuilder.group({
            ...
            denyReason: ['', {updateOn: 'blur', validators: [Validators.maxLength(5)] }],
            by: ['', {updateOn: 'blur', validators: [] }],
            date: ['', {updateOn: 'blur', validators: [] }],
            userDefined1: ['', {updateOn: 'blur', validators: [Validators.maxLength(30)] }],
            userDefined2: ['', {updateOn: 'blur', validators: [Validators.maxLength(30)] }],
            userDate1: ['', {updateOn: 'blur', validators: [this.customValidators.USDate] }],
            userDate2: ['', {updateOn: 'blur', validators: [this.customValidators.USDate] }]
        }, {updateOn: 'submit'});
    }
