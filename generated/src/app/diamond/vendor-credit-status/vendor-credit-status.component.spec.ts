...
import { VendorCreditStatusComponent } from './vendor-credit-status.component';
...
describe('VendorCreditStatusComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with VendorCreditStatusComponent setup', VendorCreditStatusComponentSetup);
...
let de: DebugElement;
let comp: VendorCreditStatusComponent;
let fixture: ComponentFixture<VendorCreditStatusComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(VendorCreditStatusComponent);
...
function VendorCreditStatusComponentSetup() {
    describe('VendorCreditStatusComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [VendorCreditStatusComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('VendorCreditStatusComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(VendorCreditStatusComponent, {
                set: {
                    providers: [
