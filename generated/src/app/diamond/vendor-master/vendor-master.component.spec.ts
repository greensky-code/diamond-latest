...
describe('VendorMasterComponent', () => {
    ...
    describe('with VendorMasterComponent setup', VendorMasterComponentSetup);
...
let de: DebugElement;
let comp: VendorMasterComponent;
...
function VendorMasterComponentSetup() {
    describe('VendorMasterComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('VendorMasterComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(VendorMasterComponent, {
                set: {
                    providers: [
