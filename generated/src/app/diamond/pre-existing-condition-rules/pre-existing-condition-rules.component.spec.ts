...
import { PreExistingConditionRulesComponent } from './pre-existing-condition-rules.component';
...
describe('PreExistingConditionRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PreExistingConditionRulesComponent setup', PreExistingConditionRulesComponentSetup);
...
let de: DebugElement;
let comp: PreExistingConditionRulesComponent;
let fixture: ComponentFixture<PreExistingConditionRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(PreExistingConditionRulesComponent);
...
function PreExistingConditionRulesComponentSetup() {
    describe('PreExistingConditionRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PreExistingConditionRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('PreExistingConditionRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PreExistingConditionRulesComponent, {
                set: {
                    providers: [
