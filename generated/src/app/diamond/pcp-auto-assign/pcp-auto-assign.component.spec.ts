...
import { PcpAutoAssignComponent } from './pcp-auto-assign.component';
...
describe('PcpAutoAssignComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PcpAutoAssignComponent setup', PcpAutoAssignComponentSetup);
...
let de: DebugElement;
let comp: PcpAutoAssignComponent;
let fixture: ComponentFixture<PcpAutoAssignComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(PcpAutoAssignComponent);
...
function PcpAutoAssignComponentSetup() {
    describe('PcpAutoAssignComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PcpAutoAssignComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('PcpAutoAssignComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PcpAutoAssignComponent, {
                set: {
                    providers: [
