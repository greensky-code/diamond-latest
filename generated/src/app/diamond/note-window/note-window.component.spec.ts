...
describe('NoteWindowComponent', () => {
    ...
    describe('with NoteWindowComponent setup', NoteWindowComponentSetup);
...
function NoteWindowComponentSetup() {
    describe('NoteWindowComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('NoteWindowComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(NoteWindowComponent, {
                set: {
                    providers: [
