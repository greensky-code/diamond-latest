...
editProcedureCodeMasterArc: boolean;
    ...
    if (this.secWin.hasInsertPermission()) {
        createProcedureCodeMasterArc() {
            ...
            if(this.medMgmtAuditForm.valid) {
                ...
                this.procedureCodeMasterArcService.createProcedureCodeMasterArc(procedureCodeMasterArc).subscribe(response => {
    ...
    updateProcedureCodeMasterArc(seqProcChangeId : number) {
        ...
        if(this.medMgmtAuditForm.valid) {
            let procedureCodeMasterArc = new ProcedureCodeMasterArc();
            this.procedureCodeMasterArcService.updateProcedureCodeMasterArc(procedureCodeMasterArc, seqProcChangeId).subscribe(response => {
        ...
        if(this.editProcedureCodeMasterArc) {
            this.updateProcedureCodeMasterArc(this.procedureCodeMasterArc.seqProcChangeId)
        } else {
        ...
        if (!(this.secWin && this.secWin.hasDeletePermission())) {
            ...
            this.procedureCodeMasterArcService.deleteProcedureCodeMasterArc(seqProcChangeId).subscribe(response => {
        ...
        this.procedureCodeMasterArcService.getProcedureCodeMasterArc(seqProcChangeId).subscribe(procedureCodeMasterArc => {
        ...
        this.procedureCodeMasterArcService.getProcedureCodeMasterArcs().subscribe(procedureCodeMasterArcs => {
