...
import {  PriceDeterminant } from "../../api-models/index"
...
editPriceDeterminant: boolean;
    ...
    updatePriceDeterminant(priceDeterminant : string) {
        this.formValidation.validateForm();
        if(this.priceDeterminantMaintenanceForm.valid) {
            let priceDeterminant = new PriceDeterminant();
            this.priceDeterminantService.updatePriceDeterminant(priceDeterminant, priceDeterminant).subscribe(response => {
        ...
        this.priceDeterminantService.getPriceDeterminant(priceDeterminant).subscribe(priceDeterminant => {
