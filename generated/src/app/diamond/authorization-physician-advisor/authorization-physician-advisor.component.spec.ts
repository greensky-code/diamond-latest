...
import { AuthorizationPhysicianAdvisorComponent } from './authorization-physician-advisor.component';
...
describe('AuthorizationPhysicianAdvisorComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AuthorizationPhysicianAdvisorComponent setup', AuthorizationPhysicianAdvisorComponentSetup);
...
let de: DebugElement;
let comp: AuthorizationPhysicianAdvisorComponent;
let fixture: ComponentFixture<AuthorizationPhysicianAdvisorComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AuthorizationPhysicianAdvisorComponent);
...
function AuthorizationPhysicianAdvisorComponentSetup() {
    describe('AuthorizationPhysicianAdvisorComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AuthorizationPhysicianAdvisorComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AuthorizationPhysicianAdvisorComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthorizationPhysicianAdvisorComponent, {
                set: {
                    providers: [
