...
import { AuthorizationProcedureComponent } from './authorization-procedure.component';
...
describe('AuthorizationProcedureComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AuthorizationProcedureComponent setup', AuthorizationProcedureComponentSetup);
...
let de: DebugElement;
let comp: AuthorizationProcedureComponent;
let fixture: ComponentFixture<AuthorizationProcedureComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AuthorizationProcedureComponent);
...
function AuthorizationProcedureComponentSetup() {
    describe('AuthorizationProcedureComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AuthorizationProcedureComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AuthorizationProcedureComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthorizationProcedureComponent, {
                set: {
                    providers: [
