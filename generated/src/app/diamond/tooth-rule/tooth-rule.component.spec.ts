...
import { ToothRuleComponent } from './tooth-rule.component';
...
describe('ToothRuleComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ToothRuleComponent setup', ToothRuleComponentSetup);
...
let de: DebugElement;
let comp: ToothRuleComponent;
let fixture: ComponentFixture<ToothRuleComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ToothRuleComponent);
...
function ToothRuleComponentSetup() {
    describe('ToothRuleComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ToothRuleComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ToothRuleComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ToothRuleComponent, {
                set: {
                    providers: [
