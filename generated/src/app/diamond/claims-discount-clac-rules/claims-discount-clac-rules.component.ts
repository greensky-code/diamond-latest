...
// Use the Component directive to define the ClaimsDiscountClacRulesComponent as an Angular component
//
...
@Component({
    ...
    selector: 'claimsdiscountclacrules',
    templateUrl: './claims-discount-clac-rules.component.html',

})
export class ClaimsDiscountClacRulesComponent implements OnInit  {

    // The form model used by the view per Angular Reactive Forms
    // See: https://angular.io/docs/ts/latest/guide/reactive-forms.html#!#intro
    claimsDiscountClacRulesForm: FormGroup;
    ...
    ngOnInit(): void {
        ...
        this.createForm();
        this.displayMessage = {};
        this.formValidation = new FormValidation(this.claimsDiscountClacRulesForm);
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.claimsDiscountClacRulesForm = this.formBuilder.group({
            ...
            rate: ['', {updateOn: 'blur', validators: [] }],
            reason: ['', {updateOn: 'blur', validators: [] }],
            searchSeq: ['', {updateOn: 'blur', validators: [] }],
            determinatTableLbDete: ['', {updateOn: 'blur', validators: [] }]
        }, {updateOn: 'submit'});
    }
