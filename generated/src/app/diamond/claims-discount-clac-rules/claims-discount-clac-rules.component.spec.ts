...
import { ClaimsDiscountClacRulesComponent } from './claims-discount-clac-rules.component';
...
describe('ClaimsDiscountClacRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimsDiscountClacRulesComponent setup', ClaimsDiscountClacRulesComponentSetup);
...
let de: DebugElement;
let comp: ClaimsDiscountClacRulesComponent;
let fixture: ComponentFixture<ClaimsDiscountClacRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimsDiscountClacRulesComponent);
...
function ClaimsDiscountClacRulesComponentSetup() {
    describe('ClaimsDiscountClacRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimsDiscountClacRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimsDiscountClacRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimsDiscountClacRulesComponent, {
                set: {
                    providers: [
