...
import { AuthBatchCloseModelComponent } from './auth-batch-close-model.component';
...
describe('AuthBatchCloseModelComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AuthBatchCloseModelComponent setup', AuthBatchCloseModelComponentSetup);
...
let de: DebugElement;
let comp: AuthBatchCloseModelComponent;
let fixture: ComponentFixture<AuthBatchCloseModelComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AuthBatchCloseModelComponent);
...
function AuthBatchCloseModelComponentSetup() {
    describe('AuthBatchCloseModelComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AuthBatchCloseModelComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AuthBatchCloseModelComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthBatchCloseModelComponent, {
                set: {
                    providers: [
