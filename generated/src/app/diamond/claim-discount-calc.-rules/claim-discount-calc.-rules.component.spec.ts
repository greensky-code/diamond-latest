...
import { ClaimDiscountCalcRulesComponent } from './claim-discount-calc.-rules.component';
...
describe('ClaimDiscountCalcRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimDiscountCalcRulesComponent setup', ClaimDiscountCalcRulesComponentSetup);
...
let de: DebugElement;
let comp: ClaimDiscountCalcRulesComponent;
let fixture: ComponentFixture<ClaimDiscountCalcRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimDiscountCalcRulesComponent);
...
function ClaimDiscountCalcRulesComponentSetup() {
    describe('ClaimDiscountCalcRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimDiscountCalcRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimDiscountCalcRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimDiscountCalcRulesComponent, {
                set: {
                    providers: [
