...
describe('CarrierComponent', () => {
    ...
    describe('with CarrierComponent setup', CarrierComponentSetup);
...
function CarrierComponentSetup() {
    describe('CarrierComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('CarrierComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(CarrierComponent, {
                set: {
                    providers: [
