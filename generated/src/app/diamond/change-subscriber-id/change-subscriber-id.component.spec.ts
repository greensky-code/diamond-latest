...
import { ChangeSubscriberIdComponent } from './change-subscriber-id.component';
...
describe('ChangeSubscriberIdComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ChangeSubscriberIdComponent setup', ChangeSubscriberIdComponentSetup);
...
let de: DebugElement;
let comp: ChangeSubscriberIdComponent;
let fixture: ComponentFixture<ChangeSubscriberIdComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ChangeSubscriberIdComponent);
...
function ChangeSubscriberIdComponentSetup() {
    describe('ChangeSubscriberIdComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ChangeSubscriberIdComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ChangeSubscriberIdComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ChangeSubscriberIdComponent, {
                set: {
                    providers: [
