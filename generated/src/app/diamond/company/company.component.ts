...
import {  CompanyMaster } from "../../api-models/index"
...
editCompanyMaster: boolean;
    ...
    if (this.secWin.hasInsertPermission()) {
        createCompanyMaster() {
            ...
            if(this.companyForm.valid) {
                ...
                companyMaster.medicalPayAcct = Form.getValue(this.companyForm, 'medicalPayable');
                companyMaster.manMedPayAcct = Form.getValue(this.companyForm, 'manualMedPayAcct');
                companyMaster.vendorMinCheck = Form.getValue(this.companyForm, 'vendMinCheck');
                companyMaster.capPayAcct = Form.getValue(this.companyForm, 'capitaledPayable');
                companyMaster.manCapPayAcct = Form.getValue(this.companyForm, 'manualCapPayAcct');
                companyMaster.subscriberMinCheck = Form.getValue(this.companyForm, 'subdepMinCheck');
                companyMaster.tradePayAcct = Form.getValue(this.companyForm, 'achEftAcct');
                companyMaster.agentCommissionPayAcct = Form.getValue(this.companyForm, 'agentCommisAcct');
                this.companyMasterService.createCompanyMaster(companyMaster).subscribe(response => {
    ...
    updateCompanyMaster(companyCode : string) {
        ...
        if(this.companyForm.valid) {
            ...
            companyMaster.tradePayAcct = Form.getValue(this.companyForm, 'achEftAcct');
            companyMaster.agentCommissionPayAcct = Form.getValue(this.companyForm, 'agentCommisAcct');
            this.companyMasterService.updateCompanyMaster(companyMaster, companyCode).subscribe(response => {
        ...
        if(this.editCompanyMaster) {
            this.updateCompanyMaster(this.companyMaster.companyCode)
        } else {
        ...
        if (!(this.secWin && this.secWin.hasDeletePermission())) {
            ...
            this.companyMasterService.deleteCompanyMaster(companyCode).subscribe(response => {
        ...
        this.companyMasterService.getCompanyMaster(companyCode).subscribe(companyMaster => {
            ...
            this.companyForm.patchValue({
                ...
                'achEftAcct': this.companyMaster.tradePayAcct,
