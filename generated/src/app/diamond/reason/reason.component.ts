    ...
    if (this.secWin.hasInsertPermission()) {
        createReasonCodeMaster() {
            ...
            if(this.reasonForm.valid) {
                ...
                reasonCodeMaster.description = Form.getValue(this.reasonForm, 'holdAction');
                reasonCodeMaster.userDate1 = Form.getValue(this.reasonForm, 'userDate1');
                reasonCodeMaster.userDate2 = Form.getValue(this.reasonForm, 'userDate2');
                reasonCodeMaster.autoAuditLocCod = Form.getValue(this.reasonForm, 'autoAudit');
                reasonCodeMaster.uncleanFlag = Form.getValue(this.reasonForm, 'uncleanIndicator');
                reasonCodeMaster.description2 = Form.getValue(this.reasonForm, 'shortDescription');
                reasonCodeMaster.calcDescription = Form.getValue(this.reasonForm, 'longDescription');
    ...
    updateReasonCodeMaster(reasonCode : string) {
        ...
        this.reasonCodeMasterService.getReasonCodeMaster(reasonCode).subscribe(reasonCodeMaster => {
            ...
            this.reasonForm.patchValue({
                ...
                'holdAction': this.reasonCodeMaster.description,
                ...
                'uncleanIndicator': this.reasonCodeMaster.uncleanFlag,
                'shortDescription': this.reasonCodeMaster.description2,
                'longDescription': this.reasonCodeMaster.calcDescription,
            });
        }, error => {
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.reasonForm = this.formBuilder.group({
            ...
            reasonCodeType: ['', {updateOn: 'blur', validators: [] }],
