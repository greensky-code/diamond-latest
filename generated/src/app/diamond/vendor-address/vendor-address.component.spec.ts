...
describe('VendorAddressComponent', () => {
    ...
    describe('with VendorAddressComponent setup', VendorAddressComponentSetup);
...
function VendorAddressComponentSetup() {
    describe('VendorAddressComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('VendorAddressComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(VendorAddressComponent, {
                set: {
                    providers: [
