...
describe('BankAccountComponent', () => {
    ...
    describe('with BankAccountComponent setup', BankAccountComponentSetup);
...
function BankAccountComponentSetup() {
    describe('BankAccountComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('BankAccountComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(BankAccountComponent, {
                set: {
                    providers: [
