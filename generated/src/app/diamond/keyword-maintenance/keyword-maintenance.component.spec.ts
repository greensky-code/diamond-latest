...
import { KeywordMaintenanceComponent } from './keyword-maintenance.component';
...
describe('KeywordMaintenanceComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with KeywordMaintenanceComponent setup', KeywordMaintenanceComponentSetup);
...
let de: DebugElement;
let comp: KeywordMaintenanceComponent;
let fixture: ComponentFixture<KeywordMaintenanceComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(KeywordMaintenanceComponent);
...
function KeywordMaintenanceComponentSetup() {
    describe('KeywordMaintenanceComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [KeywordMaintenanceComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('KeywordMaintenanceComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(KeywordMaintenanceComponent, {
                set: {
                    providers: [
