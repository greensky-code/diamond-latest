...
// Use the Component directive to define the LookupComponent as an Angular component
//
...
export class LookupComponent implements OnInit  {
    ...
    createDataGrid(): void {
      ...
      this.dataGridGridOptions.columnDefs = [
         ...
         },
         {
             ...
             width: 200         },
         {
             headerName: "Provder Master Specialty Type",
             field: "",
             width: 200         },
         {
    ...
    ngOnInit(): void {
        ...
        this.createForm();
        this.displayMessage = {};
        this.formValidation = new FormValidation(this.lookupForm);
         this.createDataGrid();
    }
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.lookupForm = this.formBuilder.group({
            cbMatchAllCa: ['', {updateOn: 'blur', validators: [] }],
            cbMatchAllContra: ['', {updateOn: 'blur', validators: [] }]
        }, {updateOn: 'submit'});
    }
