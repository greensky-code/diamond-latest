...
@Component({
    ...
    selector: 'drggrouper/pricermaintenance',
...
export class DrgGrouperpricerMaintenanceComponent implements OnInit  {
    ...
    drgGrouperpricerMaintenanceForm: FormGroup;
...
editDrgGrouperPricer: boolean;
    ...
    createDrgGrouperPricer() {
        this.formValidation.validateForm();
        if(this.drgGrouperpricerMaintenanceForm.valid) {
            let drgGrouperPricer = new DrgGrouperPricer();
            drgGrouperPricer.drgGrouperPricerId = Form.getValue(this.this.drgGrouperpricerMaintenanceForm, 'grouperpricerId');
            drgGrouperPricer.version = Form.getValue(this.this.drgGrouperpricerMaintenanceForm, 'version');
            drgGrouperPricer.payorCode = Form.getValue(this.this.drgGrouperpricerMaintenanceForm, 'code');
            drgGrouperPricer.description = Form.getValue(this.this.drgGrouperpricerMaintenanceForm, 'description');
    ...
    updateDrgGrouperPricer(drgGrouperPricerId : string) {
        this.formValidation.validateForm();
        if(this.drgGrouperpricerMaintenanceForm.valid) {
            let drgGrouperPricer = new DrgGrouperPricer();
            drgGrouperPricer.drgGrouperPricerId = Form.getValue(this.this.drgGrouperpricerMaintenanceForm, 'grouperpricerId');
    ...
    }    deleteDrgGrouperPricer(drgGrouperPricerId : string) {
