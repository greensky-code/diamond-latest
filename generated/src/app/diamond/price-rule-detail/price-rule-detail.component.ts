...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.priceRuleDetailForm = this.formBuilder.group({
            priceRule001: ['', {updateOn: 'blur', validators: [] }],
            priceRuleDescription: ['', {updateOn: 'blur', validators: [] }],
            priceRule002: ['', {updateOn: 'blur', validators: [] }],
            modifierCode: ['', {updateOn: 'blur', validators: [] }],
            ruleLevel: ['', {updateOn: 'blur', validators: [] }],
            searchSequence: ['', {updateOn: 'blur', validators: [] }],
            calculationMethod: ['', {updateOn: 'blur', validators: [] }],
