...
import {  MedDefnCode } from "../../api-models/index"
import {  MedDefnCodeService } from "../../api-services/med-defn-code.service"
...
editMedDefnCode: boolean;
    ...
    createMedDefnCode() {
        ...
        if(this.medicalDefinitionsLookupForm.valid) {
            let medDefnCode = new MedDefnCode();
            this.medDefnCodeService.createMedDefnCode(medDefnCode).subscribe(response => {
                this.alertMessage = this.alertMessageService.info("Record successfully created.");
                this.editMedDefnCode = false;
            }, error => {
    ...
    updateMedDefnCode(medDefCode : string) {
        this.formValidation.validateForm();
        if(this.medicalDefinitionsLookupForm.valid) {
            let medDefnCode = new MedDefnCode();
            this.medDefnCodeService.updateMedDefnCode(medDefnCode, medDefCode).subscribe(response => {
        ...
        if(this.editMedDefnCode) {
            this.updateMedDefnCode(this.medDefnCode.medDefCode)
        } else {
            this.createMedDefnCode();
        }
    }    deleteMedDefnCode(medDefCode : string) {
        this.medDefnCodeService.deleteMedDefnCode(medDefCode).subscribe(response => {
            this.alertMessage = this.alertMessageService.info("Record successfully deleted.");
        }, error => {
            this.alertMessage = this.alertMessageService.error("An Error occurred while deleting record.");
        });
    }    getMedDefnCode(medDefCode : string) {
        this.medDefnCodeService.getMedDefnCode(medDefCode).subscribe(medDefnCode => {
            this.medDefnCode = medDefnCode;
