...
import { MedicalDefinitionsLookupComponent } from './medical-definitions-lookup.component';
...
describe('MedicalDefinitionsLookupComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with MedicalDefinitionsLookupComponent setup', MedicalDefinitionsLookupComponentSetup);
...
let de: DebugElement;
let comp: MedicalDefinitionsLookupComponent;
let fixture: ComponentFixture<MedicalDefinitionsLookupComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(MedicalDefinitionsLookupComponent);
...
function MedicalDefinitionsLookupComponentSetup() {
    describe('MedicalDefinitionsLookupComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MedicalDefinitionsLookupComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MedicalDefinitionsLookupComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MedicalDefinitionsLookupComponent, {
                set: {
                    providers: [
