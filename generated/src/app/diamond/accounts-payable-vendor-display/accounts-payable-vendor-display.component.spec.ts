...
import { AccountsPayableVendorDisplayComponent } from './accounts-payable-vendor-display.component';
...
describe('AccountsPayableVendorDisplayComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AccountsPayableVendorDisplayComponent setup', AccountsPayableVendorDisplayComponentSetup);
...
let de: DebugElement;
let comp: AccountsPayableVendorDisplayComponent;
let fixture: ComponentFixture<AccountsPayableVendorDisplayComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AccountsPayableVendorDisplayComponent);
...
function AccountsPayableVendorDisplayComponentSetup() {
    describe('AccountsPayableVendorDisplayComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AccountsPayableVendorDisplayComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AccountsPayableVendorDisplayComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AccountsPayableVendorDisplayComponent, {
                set: {
                    providers: [
