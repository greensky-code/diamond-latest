...
import { ClaimAuthProcRuleComponent } from './claim-auth-proc-rule.component';
...
describe('ClaimAuthProcRuleComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimAuthProcRuleComponent setup', ClaimAuthProcRuleComponentSetup);
...
let de: DebugElement;
let comp: ClaimAuthProcRuleComponent;
let fixture: ComponentFixture<ClaimAuthProcRuleComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimAuthProcRuleComponent);
...
function ClaimAuthProcRuleComponentSetup() {
    describe('ClaimAuthProcRuleComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimAuthProcRuleComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimAuthProcRuleComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimAuthProcRuleComponent, {
                set: {
                    providers: [
