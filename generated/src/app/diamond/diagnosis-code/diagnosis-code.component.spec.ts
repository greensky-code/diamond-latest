...
describe('DiagnosisCodeComponent', () => {
    ...
    describe('with DiagnosisCodeComponent setup', DiagnosisCodeComponentSetup);
...
let de: DebugElement;
let comp: DiagnosisCodeComponent;
...
function DiagnosisCodeComponentSetup() {
    describe('DiagnosisCodeComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('DiagnosisCodeComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(DiagnosisCodeComponent, {
                set: {
                    providers: [
