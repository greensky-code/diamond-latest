...
describe('FunctionDescriptionComponent', () => {
    ...
    describe('with FunctionDescriptionComponent setup', FunctionDescriptionComponentSetup);
...
let de: DebugElement;
let comp: FunctionDescriptionComponent;
...
function FunctionDescriptionComponentSetup() {
    describe('FunctionDescriptionComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('FunctionDescriptionComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(FunctionDescriptionComponent, {
                set: {
                    providers: [
