...
describe('RuleCopyComponent', () => {
    ...
    describe('with RuleCopyComponent setup', RuleCopyComponentSetup);
...
function RuleCopyComponentSetup() {
    describe('RuleCopyComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('RuleCopyComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(RuleCopyComponent, {
                set: {
                    providers: [
