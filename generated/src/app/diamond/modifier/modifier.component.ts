...
import {  ModifierCodeMaster } from "../../api-models/index"
import {  ModifierCodeMasterService } from "../../api-services/modifier-code-master.service"
import { AlertMessage, AlertMessageService } from '../../shared/components/alert-message/index'
import { SecWinService } from '../../../api-services/security/sec-win.service';

// Use the Component directive to define the ModifierComponent as an Angular component
//
...
editModifierCodeMaster: boolean;
    ...
    if (this.secWin.hasInsertPermission()) {
        createModifierCodeMaster() {
            ...
            if(this.modifierForm.valid) {
                ...
                modifierCodeMaster.anesthesiaInd = Form.getValue(this.modifierForm, 'anesthesia');
                modifierCodeMaster.informationalFlag = Form.getValue(this.modifierForm, 'informationalOnly');
    ...
    updateModifierCodeMaster(modifierCode : string) {
        ...
        this.modifierCodeMasterService.getModifierCodeMaster(modifierCode).subscribe(modifierCodeMaster => {
            this.modifierCodeMaster = modifierCodeMaster;
            this.modifierForm.patchValue({
                ...
                'anesthesia': this.modifierCodeMaster.anesthesiaInd,
                'informationalOnly': this.modifierCodeMaster.informationalFlag,
        ...
        this.modifierCodeMasterService.getModifierCodeMasters().subscribe(modifierCodeMasters => {
        this.modifierCodeMasters = modifierCodeMasters;
        }, error => {
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.modifierForm = this.formBuilder.group({
            modifierId: ['', {updateOn: 'blur', validators: [] }],
