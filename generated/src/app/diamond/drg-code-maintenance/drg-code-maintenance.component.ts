...
import {  DrgMaster } from "../../api-models/index"
...
editDrgMaster: boolean;
    ...
    createDrgMaster() {
        ...
        if(this.drgCodeMaintenanceForm.valid) {
            ...
            drgMaster.drgCode = Form.getValue(this.this.drgCodeMaintenanceForm, 'drgCode');
            drgMaster.shortDescription = Form.getValue(this.this.drgCodeMaintenanceForm, 'shortDescription');
            drgMaster.description = Form.getValue(this.this.drgCodeMaintenanceForm, 'description');
