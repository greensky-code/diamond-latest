...
import {  SystemParameter } from "../../api-models/index"
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.parameterForm = this.formBuilder.group({
            parameterId: ['', {updateOn: 'blur', validators: [] }],
            parameter1: ['', {updateOn: 'blur', validators: [] }],
            parameter2: ['', {updateOn: 'blur', validators: [] }],
            parameter3: ['', {updateOn: 'blur', validators: [] }],
