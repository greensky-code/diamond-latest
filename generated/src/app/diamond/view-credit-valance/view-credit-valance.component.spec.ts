...
import { ViewCreditValanceComponent } from './view-credit-valance.component';
...
describe('ViewCreditValanceComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ViewCreditValanceComponent setup', ViewCreditValanceComponentSetup);
...
let de: DebugElement;
let comp: ViewCreditValanceComponent;
let fixture: ComponentFixture<ViewCreditValanceComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ViewCreditValanceComponent);
...
function ViewCreditValanceComponentSetup() {
    describe('ViewCreditValanceComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ViewCreditValanceComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ViewCreditValanceComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ViewCreditValanceComponent, {
                set: {
                    providers: [
