...
import { AuditTrailMaintenanceComponent } from './audit-trail-maintenance.component';
...
describe('AuditTrailMaintenanceComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AuditTrailMaintenanceComponent setup', AuditTrailMaintenanceComponentSetup);
...
let de: DebugElement;
let comp: AuditTrailMaintenanceComponent;
let fixture: ComponentFixture<AuditTrailMaintenanceComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AuditTrailMaintenanceComponent);
...
function AuditTrailMaintenanceComponentSetup() {
    describe('AuditTrailMaintenanceComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AuditTrailMaintenanceComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AuditTrailMaintenanceComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuditTrailMaintenanceComponent, {
                set: {
                    providers: [
