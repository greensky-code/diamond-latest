...
import {  ClmDtlAuthProcLnkRule } from "../../api-models/index"
...
@Component({
    ...
    selector: 'claimdetailauthprocrule',
...
editClmDtlAuthProcLnkRule: boolean;
    ...
    updateClmDtlAuthProcLnkRule(ruleId : string) {
        ...
        this.clmDtlAuthProcLnkRuleService.getClmDtlAuthProcLnkRule(ruleId).subscribe(clmDtlAuthProcLnkRule => {
            ...
            this.claimDetailAuthProcRuleForm.patchValue({
                ...
                'submtVsAuthProcCode': this.clmDtlAuthProcLnkRule.submtVsAuthProcCode,
                'priceOnAuthProc': this.clmDtlAuthProcLnkRule.priceOnAuthProcCode,
