...
describe('MemberAddressComponent', () => {
    ...
    describe('with MemberAddressComponent setup', MemberAddressComponentSetup);
...
let de: DebugElement;
let comp: MemberAddressComponent;
...
function MemberAddressComponentSetup() {
    describe('MemberAddressComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('MemberAddressComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MemberAddressComponent, {
                set: {
                    providers: [
