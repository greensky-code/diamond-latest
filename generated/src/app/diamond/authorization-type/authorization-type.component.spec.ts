...
describe('AuthorizationTypeComponent', () => {
    ...
    describe('with AuthorizationTypeComponent setup', AuthorizationTypeComponentSetup);
...
let de: DebugElement;
let comp: AuthorizationTypeComponent;
...
function AuthorizationTypeComponentSetup() {
    describe('AuthorizationTypeComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('AuthorizationTypeComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthorizationTypeComponent, {
                set: {
                    providers: [
