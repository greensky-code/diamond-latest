...
import {  BillTypeMaster } from "../../api-models/index"
    ...
    if (this.secWin.hasInsertPermission()) {
        createBillTypeMaster() {
            ...
            if(this.billTypesInstitutionalClaimsForm.valid) {
                ...
                billTypeMaster.inpOutpInd = Form.getValue(this.billTypesInstitutionalClaimsForm, 'inpatientoutpatient');
                billTypeMaster.placeOfService = Form.getValue(this.billTypesInstitutionalClaimsForm, 'placeOfServiceTbInpati');
    ...
    updateBillTypeMaster(billType : string) {
        ...
        this.billTypeMasterService.getBillTypeMaster(billType).subscribe(billTypeMaster => {
            ...
            this.billTypesInstitutionalClaimsForm.patchValue({
                'inpatientoutpatient': this.billTypeMaster.inpOutpInd,
                'placeOfServiceTbInpati': this.billTypeMaster.placeOfService,
            });
        }, error => {
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.billTypesInstitutionalClaimsForm = this.formBuilder.group({
            ...
            inpatientoutpatient: ['', {updateOn: 'blur', validators: [] }],
            placeOfServiceTbInpati: ['', {updateOn: 'blur', validators: [] }],
