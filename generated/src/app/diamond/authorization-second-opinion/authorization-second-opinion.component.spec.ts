...
describe('AuthorizationSecondOpinionComponent', () => {
    ...
    describe('with AuthorizationSecondOpinionComponent setup', AuthorizationSecondOpinionComponentSetup);
...
let de: DebugElement;
let comp: AuthorizationSecondOpinionComponent;
...
function AuthorizationSecondOpinionComponentSetup() {
    describe('AuthorizationSecondOpinionComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('AuthorizationSecondOpinionComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthorizationSecondOpinionComponent, {
                set: {
                    providers: [
