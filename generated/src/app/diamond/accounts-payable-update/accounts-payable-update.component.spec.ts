...
import { AccountsPayableUpdateComponent } from './accounts-payable-update.component';
...
describe('AccountsPayableUpdateComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AccountsPayableUpdateComponent setup', AccountsPayableUpdateComponentSetup);
...
let de: DebugElement;
let comp: AccountsPayableUpdateComponent;
let fixture: ComponentFixture<AccountsPayableUpdateComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AccountsPayableUpdateComponent);
...
function AccountsPayableUpdateComponentSetup() {
    describe('AccountsPayableUpdateComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AccountsPayableUpdateComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AccountsPayableUpdateComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AccountsPayableUpdateComponent, {
                set: {
                    providers: [
