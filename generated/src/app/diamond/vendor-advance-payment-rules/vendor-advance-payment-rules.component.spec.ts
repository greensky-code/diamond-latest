...
import { VendorAdvancePaymentRulesComponent } from './vendor-advance-payment-rules.component';
...
describe('VendorAdvancePaymentRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with VendorAdvancePaymentRulesComponent setup', VendorAdvancePaymentRulesComponentSetup);
...
let de: DebugElement;
let comp: VendorAdvancePaymentRulesComponent;
let fixture: ComponentFixture<VendorAdvancePaymentRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(VendorAdvancePaymentRulesComponent);
...
function VendorAdvancePaymentRulesComponentSetup() {
    describe('VendorAdvancePaymentRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [VendorAdvancePaymentRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('VendorAdvancePaymentRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(VendorAdvancePaymentRulesComponent, {
                set: {
                    providers: [
