...
import { InstitutionalClaimsComponent } from './institutional-claims.component';
...
describe('InstitutionalClaimsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with InstitutionalClaimsComponent setup', InstitutionalClaimsComponentSetup);
...
let de: DebugElement;
let comp: InstitutionalClaimsComponent;
let fixture: ComponentFixture<InstitutionalClaimsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(InstitutionalClaimsComponent);
...
function InstitutionalClaimsComponentSetup() {
    describe('InstitutionalClaimsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [InstitutionalClaimsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('InstitutionalClaimsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(InstitutionalClaimsComponent, {
                set: {
                    providers: [
