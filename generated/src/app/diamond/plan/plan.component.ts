...
import {  PlanMaster } from "../../api-models/index"
...
editPlanMaster: boolean;
    ...
    if (this.secWin.hasInsertPermission()) {
        createPlanMaster() {
            ...
            if(this.planForm.valid) {
                ...
                this.planMasterService.createPlanMaster(planMaster).subscribe(response => {
    ...
    updatePlanMaster(planCode : string) {
        ...
        if(this.planForm.valid) {
            ...
            planMaster.description = Form.getValue(this.planForm, 'description');
            planMaster.autoAuditPlanId = Form.getValue(this.planForm, 'autoAudit');
            this.planMasterService.updatePlanMaster(planMaster, planCode).subscribe(response => {
        ...
        if(this.editPlanMaster) {
            this.updatePlanMaster(this.planMaster.planCode)
        } else {
