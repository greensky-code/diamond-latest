...
describe('ConversionFactorComponent', () => {
    ...
    describe('with ConversionFactorComponent setup', ConversionFactorComponentSetup);
...
let de: DebugElement;
let comp: ConversionFactorComponent;
...
function ConversionFactorComponentSetup() {
    describe('ConversionFactorComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('ConversionFactorComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ConversionFactorComponent, {
                set: {
                    providers: [
