...
import { ConversionFactorTypes } from "../api-models/testing/fake-conversion-factor-type.model"
...
describe('ConversionFactorTypeService', () => {
  ...
  describe('#getConversionFactorTypes', () => {
    it('should return an Promise<ConversionFactorType[]>', () => {
      const conversionFactorType = [
       {convFactorId:'sample data', description:'sample data', securityCode:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data'},
       {convFactorId:'sample data', description:'sample data', securityCode:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data'},
       {convFactorId:'sample data', description:'sample data', securityCode:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data'}
  ...
  describe('#createConversionFactorType', () => {
    var id = 1;
    it('should return an Promise<ConversionFactorType>', () => {
      const conversionFactorType: ConversionFactorType = {convFactorId:'sample data', description:'sample data', securityCode:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data'};
  ...
  describe('#updateConversionFactorType', () => {
    ...
    it('should return an Promise<ConversionFactorType>', () => {
      const conversionFactorType: ConversionFactorType = {convFactorId:'sample data', description:'sample data', securityCode:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data'};
      service.updateConversionFactorType(conversionFactorType, id).subscribe(response => {
         expect(response).toEqual(null);
      });
  ...
  describe('#deleteConversionFactorType', () => {
    ...
    it('should call delete method with correct parameter', () => {
      service.deleteConversionFactorType(id).subscribe(response => {
         expect(response).toEqual(null);
      });
      const req = httpMock.expectOne(`${environment.apiUrl}/conversionfactortypes/${id}`);
