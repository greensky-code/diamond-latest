...
import 'rxjs/add/operator/map';
import { ProcGetGroupFiling } from '../api-models/proc-get-group-filing.input-model'
import { ProcGetGroupFilingViewModel } from '../api-models/proc-get-group-filing.view-model'
...
@Injectable()
export class ProcGetGroupFilingService {

    private procGetGroupFilingUrl: string = `${environment.apiUrl}/procgetgroupfilings`;
    ...
    procGetGroupFiling(procGetGroupFiling : ProcGetGroupFiling): Promise<ProcGetGroupFilingViewModel[]> {
        let body = JSON.stringify(procGetGroupFiling);
        return this.httpClient.post(this.procGetGroupFilingUrl, body, { headers: this.contentHeaders })
            .toPromise()
