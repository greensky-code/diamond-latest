...
import 'rxjs/add/operator/map';
import { ProcGetGroupAddr } from '../api-models/proc-get-group-addr.input-model'
import { ProcGetGroupAddrViewModel } from '../api-models/proc-get-group-addr.view-model'
...
export class ProcGetGroupAddrService {
    ...
    private procGetGroupAddrUrl: string = `${environment.apiUrl}/procgetgroupaddrs`;
    ...
    procGetGroupAddr(procGetGroupAddr : ProcGetGroupAddr): Promise<ProcGetGroupAddrViewModel[]> {
