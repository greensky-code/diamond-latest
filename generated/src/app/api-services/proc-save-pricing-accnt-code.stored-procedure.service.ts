...
import 'rxjs/add/operator/map';
import { ProcSavePricingAccntCode } from '../api-models/proc-save-pricing-accnt-code.input-model'
import { ProcSavePricingAccntCodeViewModel } from '../api-models/proc-save-pricing-accnt-code.view-model'
...
export class ProcSavePricingAccntCodeService {
    ...
    private procSavePricingAccntCodeUrl: string = `${environment.apiUrl}/procsavepricingaccntcodes`;
    ...
    procSavePricingAccntCode(procSavePricingAccntCode : ProcSavePricingAccntCode): Promise<ProcSavePricingAccntCodeViewModel[]> {
        let body = JSON.stringify(procSavePricingAccntCode);
        return this.httpClient.post(this.procSavePricingAccntCodeUrl, body, { headers: this.contentHeaders })
            .toPromise()
