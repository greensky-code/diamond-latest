...
describe('GetProvinceHistoryService', () => {
  ...
  describe('#getGetProvinceHistorys', () => {
    it('should return an Promise<GetProvinceHistory[]>', () => {
      const getProvinceHistory = [
       {pTaxRegion:'sample data', pTaxType:'sample data', pTaxProduct:'sample data', pFundType:'sample data', pProvinceHist:'sample data'},
       {pTaxRegion:'sample data', pTaxType:'sample data', pTaxProduct:'sample data', pFundType:'sample data', pProvinceHist:'sample data'},
       {pTaxRegion:'sample data', pTaxType:'sample data', pTaxProduct:'sample data', pFundType:'sample data', pProvinceHist:'sample data'}
  ...
  describe('#createGetProvinceHistory', () => {
    var id = 1;
    it('should return an Promise<GetProvinceHistory>', () => {
      const getProvinceHistory: GetProvinceHistory = {pTaxRegion:'sample data', pTaxType:'sample data', pTaxProduct:'sample data', pFundType:'sample data', pProvinceHist:'sample data'};
