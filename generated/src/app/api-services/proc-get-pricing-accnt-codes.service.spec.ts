...
describe('ProcGetPricingAccntCodesService', () => {
  ...
  describe('#getProcGetPricingAccntCode', () => {
    it('should return an Promise<ProcGetPricingAccntCodes[]>', () => {
      const procGetPricingAccntCodes = [
       {pGroupId:'sample data', pSeqGroupId:1234, pGroupName:'sample data', pResult:'sample data'},
       {pGroupId:'sample data', pSeqGroupId:1234, pGroupName:'sample data', pResult:'sample data'},
       {pGroupId:'sample data', pSeqGroupId:1234, pGroupName:'sample data', pResult:'sample data'}
  ...
  describe('#createProcGetPricingAccntCodes', () => {
    var id = 1;
    it('should return an Promise<ProcGetPricingAccntCodes>', () => {
      const procGetPricingAccntCodes: ProcGetPricingAccntCodes = {pGroupId:'sample data', pSeqGroupId:1234, pGroupName:'sample data', pResult:'sample data'};
