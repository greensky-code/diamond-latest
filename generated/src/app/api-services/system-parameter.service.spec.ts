...
describe('SystemParameterService', () => {
  ...
  describe('#getSystemParameters', () => {
    it('should return an Promise<SystemParameter[]>', () => {
      const systemParameter = [
       {parameterId:'sample data', parameter1:'sample data', parameter2:'sample data', description:'sample data', securityCode:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data', parameter3:'sample data'},
       {parameterId:'sample data', parameter1:'sample data', parameter2:'sample data', description:'sample data', securityCode:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data', parameter3:'sample data'},
       {parameterId:'sample data', parameter1:'sample data', parameter2:'sample data', description:'sample data', securityCode:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data', parameter3:'sample data'}

      ];
      service.getSystemParameters().subscribe(users => {
  ...
  describe('#createSystemParameter', () => {
    var id = 1;
    it('should return an Promise<SystemParameter>', () => {
      const systemParameter: SystemParameter = {parameterId:'sample data', parameter1:'sample data', parameter2:'sample data', description:'sample data', securityCode:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data', parameter3:'sample data'};
      service.createSystemParameter(systemParameter).subscribe(response => {
  ...
  describe('#updateSystemParameter', () => {
    ...
    it('should return an Promise<SystemParameter>', () => {
      const systemParameter: SystemParameter = {parameterId:'sample data', parameter1:'sample data', parameter2:'sample data', description:'sample data', securityCode:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data', parameter3:'sample data'};
      service.updateSystemParameter(systemParameter, id).subscribe(response => {
         expect(response).toEqual(null);
      });
  ...
  describe('#deleteSystemParameter', () => {
    ...
    it('should call delete method with correct parameter', () => {
      service.deleteSystemParameter(id).subscribe(response => {
         expect(response).toEqual(null);
      });
      const req = httpMock.expectOne(`${environment.apiUrl}/systemparameters/${id}`);
