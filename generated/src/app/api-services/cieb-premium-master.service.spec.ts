...
describe('CiebPremiumMasterService', () => {
  ...
  describe('#getCiebPremiumMasters', () => {
    it('should return an Promise<CiebPremiumMaster[]>', () => {
      const ciebPremiumMaster = [
       {updateProcess:'sample data', updateUser:'sample data', updateDatetime:'2018-01-01', insertProcess:'sample data', insertUser:'sample data', insertDatetime:'2018-01-01', rxprimePlancodeFlag:'sample data', planEndDate:'2018-01-01', planEffectiveDate:'2018-01-01', policyCode:'sample data', claimDivision:'sample data', rxprimeAcctNum:'sample data', hsdPlancode:'sample data', seqPremId:1234, seqGroupId:1234},
       {updateProcess:'sample data', updateUser:'sample data', updateDatetime:'2018-01-01', insertProcess:'sample data', insertUser:'sample data', insertDatetime:'2018-01-01', rxprimePlancodeFlag:'sample data', planEndDate:'2018-01-01', planEffectiveDate:'2018-01-01', policyCode:'sample data', claimDivision:'sample data', rxprimeAcctNum:'sample data', hsdPlancode:'sample data', seqPremId:1234, seqGroupId:1234},
       {updateProcess:'sample data', updateUser:'sample data', updateDatetime:'2018-01-01', insertProcess:'sample data', insertUser:'sample data', insertDatetime:'2018-01-01', rxprimePlancodeFlag:'sample data', planEndDate:'2018-01-01', planEffectiveDate:'2018-01-01', policyCode:'sample data', claimDivision:'sample data', rxprimeAcctNum:'sample data', hsdPlancode:'sample data', seqPremId:1234, seqGroupId:1234}
  ...
  describe('#createCiebPremiumMaster', () => {
    var id = 1;
    it('should return an Promise<CiebPremiumMaster>', () => {
      const ciebPremiumMaster: CiebPremiumMaster = {updateProcess:'sample data', updateUser:'sample data', updateDatetime:'2018-01-01', insertProcess:'sample data', insertUser:'sample data', insertDatetime:'2018-01-01', rxprimePlancodeFlag:'sample data', planEndDate:'2018-01-01', planEffectiveDate:'2018-01-01', policyCode:'sample data', claimDivision:'sample data', rxprimeAcctNum:'sample data', hsdPlancode:'sample data', seqPremId:1234, seqGroupId:1234};
