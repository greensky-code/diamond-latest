...
describe('CiebStateCodeService', () => {
  ...
  describe('#getCiebStateCodes', () => {
    it('should return an Promise<CiebStateCode[]>', () => {
      const ciebStateCode = [
       {updateUser:'sample data', updateProcess:'sample data', updateDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', insertDatetime:'2018-01-01', stateDesc:'sample data', stateCode:'sample data'},
       {updateUser:'sample data', updateProcess:'sample data', updateDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', insertDatetime:'2018-01-01', stateDesc:'sample data', stateCode:'sample data'},
       {updateUser:'sample data', updateProcess:'sample data', updateDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', insertDatetime:'2018-01-01', stateDesc:'sample data', stateCode:'sample data'}
  ...
  describe('#createCiebStateCode', () => {
    var id = 1;
    it('should return an Promise<CiebStateCode>', () => {
      const ciebStateCode: CiebStateCode = {updateUser:'sample data', updateProcess:'sample data', updateDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', insertDatetime:'2018-01-01', stateDesc:'sample data', stateCode:'sample data'};
