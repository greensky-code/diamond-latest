...
import { CignaLinkDetailsComponent } from './cigna-link-details.component';
...
describe('CignaLinkDetailsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with CignaLinkDetailsComponent setup', CignaLinkDetailsComponentSetup);
...
let de: DebugElement;
let comp: CignaLinkDetailsComponent;
let fixture: ComponentFixture<CignaLinkDetailsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(CignaLinkDetailsComponent);
...
function CignaLinkDetailsComponentSetup() {
    describe('CignaLinkDetailsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CignaLinkDetailsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('CignaLinkDetailsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(CignaLinkDetailsComponent, {
                set: {
                    providers: [
