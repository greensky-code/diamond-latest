...
import { LocalCurrencyConversionComponent } from './local-currency-conversion.component';
...
describe('LocalCurrencyConversionComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with LocalCurrencyConversionComponent setup', LocalCurrencyConversionComponentSetup);
...
let de: DebugElement;
let comp: LocalCurrencyConversionComponent;
let fixture: ComponentFixture<LocalCurrencyConversionComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(LocalCurrencyConversionComponent);
...
function LocalCurrencyConversionComponentSetup() {
    describe('LocalCurrencyConversionComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [LocalCurrencyConversionComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('LocalCurrencyConversionComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(LocalCurrencyConversionComponent, {
                set: {
                    providers: [
