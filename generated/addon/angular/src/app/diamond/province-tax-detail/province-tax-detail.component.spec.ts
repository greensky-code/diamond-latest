...
import { ProvinceTaxDetailComponent } from './province-tax-detail.component';
...
describe('ProvinceTaxDetailComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ProvinceTaxDetailComponent setup', ProvinceTaxDetailComponentSetup);
...
let de: DebugElement;
let comp: ProvinceTaxDetailComponent;
let fixture: ComponentFixture<ProvinceTaxDetailComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ProvinceTaxDetailComponent);
...
function ProvinceTaxDetailComponentSetup() {
    describe('ProvinceTaxDetailComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ProvinceTaxDetailComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ProvinceTaxDetailComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ProvinceTaxDetailComponent, {
                set: {
                    providers: [
