...
describe('BankInfoComponent', () => {
    ...
    describe('with BankInfoComponent setup', BankInfoComponentSetup);
...
function BankInfoComponentSetup() {
    describe('BankInfoComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('BankInfoComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(BankInfoComponent, {
                set: {
                    providers: [
