...
// Use the Component directive to define the EmailComponent as an Angular component
//
...
export class EmailComponent implements OnInit  {
    ...
    ngOnInit(): void {
        ...
        this.createForm();
        this.displayMessage = {};
        this.formValidation = new FormValidation(this.emailForm);
         this.createDataGrid();
    }
