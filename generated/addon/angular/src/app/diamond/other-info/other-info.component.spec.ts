...
describe('OtherInfoComponent', () => {
    ...
    describe('with OtherInfoComponent setup', OtherInfoComponentSetup);
...
function OtherInfoComponentSetup() {
    describe('OtherInfoComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('OtherInfoComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(OtherInfoComponent, {
                set: {
                    providers: [
