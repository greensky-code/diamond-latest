...
import { PricingPartnerDetailComponent } from './pricing-partner-detail.component';
...
describe('PricingPartnerDetailComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PricingPartnerDetailComponent setup', PricingPartnerDetailComponentSetup);
...
let de: DebugElement;
let comp: PricingPartnerDetailComponent;
let fixture: ComponentFixture<PricingPartnerDetailComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(PricingPartnerDetailComponent);
...
function PricingPartnerDetailComponentSetup() {
    describe('PricingPartnerDetailComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PricingPartnerDetailComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('PricingPartnerDetailComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PricingPartnerDetailComponent, {
                set: {
                    providers: [
