...
describe('PlayerDetailsComponent', () => {
    ...
    describe('with PlayerDetailsComponent setup', PlayerDetailsComponentSetup);
...
let de: DebugElement;
let comp: PlayerDetailsComponent;
...
function PlayerDetailsComponentSetup() {
...
function formsModuleSetup() {
    ...
    describe('PlayerDetailsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PlayerDetailsComponent, {
                set: {
                    providers: [
