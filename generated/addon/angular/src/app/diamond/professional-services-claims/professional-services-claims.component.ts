...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.professionalServicesClaimsForm = this.formBuilder.group({
            ...
            phsicianAcceptsAssignment: ['', {updateOn: 'blur', validators: [] }],
            onsetDate: ['', {updateOn: 'blur', validators: [] }],
            similarSymptomDate: ['', {updateOn: 'blur', validators: [] }],
            hospitalAdminDate: ['', {updateOn: 'blur', validators: [] }],
            ...
            lastFoodCareVisit: ['', {updateOn: 'blur', validators: [] }],
            ...
            conditionsCodess: ['', {updateOn: 'blur', validators: [] }],
