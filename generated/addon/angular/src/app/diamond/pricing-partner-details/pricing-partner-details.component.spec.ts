...
import { PricingPartnerDetailsComponent } from './pricing-partner-details.component';
...
describe('PricingPartnerDetailsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PricingPartnerDetailsComponent setup', PricingPartnerDetailsComponentSetup);
...
let de: DebugElement;
let comp: PricingPartnerDetailsComponent;
let fixture: ComponentFixture<PricingPartnerDetailsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(PricingPartnerDetailsComponent);
...
function PricingPartnerDetailsComponentSetup() {
    describe('PricingPartnerDetailsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PricingPartnerDetailsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('PricingPartnerDetailsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PricingPartnerDetailsComponent, {
                set: {
                    providers: [
