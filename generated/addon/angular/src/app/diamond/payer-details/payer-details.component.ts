...
// Use the Component directive to define the PayerDetailsComponent as an Angular component
//
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.payerDetailsForm = this.formBuilder.group({
            ...
            radiobuttongroup4426: ['', {updateOn: 'blur', validators: [] }],
            radiobuttongroup1798: ['', {updateOn: 'blur', validators: [] }],
            ...
            playerStartDate: ['', {updateOn: 'blur', validators: [] }]
        }, {updateOn: 'submit'});
    }
