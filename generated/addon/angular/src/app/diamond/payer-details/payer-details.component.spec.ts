...
describe('PayerDetailsComponent', () => {
    ...
    describe('with PayerDetailsComponent setup', PayerDetailsComponentSetup);
...
let de: DebugElement;
let comp: PayerDetailsComponent;
...
function PayerDetailsComponentSetup() {
    describe('PayerDetailsComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('PayerDetailsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PayerDetailsComponent, {
                set: {
                    providers: [
