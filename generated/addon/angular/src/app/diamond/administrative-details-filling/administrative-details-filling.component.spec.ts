...
import { AdministrativeDetailsFillingComponent } from './administrative-details-filling.component';
...
describe('AdministrativeDetailsFillingComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AdministrativeDetailsFillingComponent setup', AdministrativeDetailsFillingComponentSetup);
...
let de: DebugElement;
let comp: AdministrativeDetailsFillingComponent;
let fixture: ComponentFixture<AdministrativeDetailsFillingComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AdministrativeDetailsFillingComponent);
...
function AdministrativeDetailsFillingComponentSetup() {
    describe('AdministrativeDetailsFillingComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AdministrativeDetailsFillingComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AdministrativeDetailsFillingComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AdministrativeDetailsFillingComponent, {
                set: {
                    providers: [
