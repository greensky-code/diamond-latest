...
describe('ChangeHeaderComponent', () => {
    ...
    describe('with ChangeHeaderComponent setup', ChangeHeaderComponentSetup);
...
let de: DebugElement;
let comp: ChangeHeaderComponent;
...
function ChangeHeaderComponentSetup() {
    describe('ChangeHeaderComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('ChangeHeaderComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ChangeHeaderComponent, {
                set: {
                    providers: [
