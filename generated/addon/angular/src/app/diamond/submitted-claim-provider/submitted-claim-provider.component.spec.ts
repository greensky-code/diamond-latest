...
import { SubmittedClaimProviderComponent } from './submitted-claim-provider.component';
...
describe('SubmittedClaimProviderComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with SubmittedClaimProviderComponent setup', SubmittedClaimProviderComponentSetup);
...
let de: DebugElement;
let comp: SubmittedClaimProviderComponent;
let fixture: ComponentFixture<SubmittedClaimProviderComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(SubmittedClaimProviderComponent);
...
function SubmittedClaimProviderComponentSetup() {
    describe('SubmittedClaimProviderComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [SubmittedClaimProviderComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('SubmittedClaimProviderComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(SubmittedClaimProviderComponent, {
                set: {
                    providers: [
