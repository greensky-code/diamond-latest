...
// Use the Component directive to define the AdministrativeDetailsComponent as an Angular component
//
...
@Component({
    ...
    selector: 'administrativedetails',
    templateUrl: './administrative-details.component.html',

})
export class AdministrativeDetailsComponent implements OnInit  {
    ...
    ngOnInit(): void {
        ...
        this.createForm();
        this.displayMessage = {};
        this.formValidation = new FormValidation(this.administrativeDetailsForm);
         this.createDataGrid();
    }
