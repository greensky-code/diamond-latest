...
describe('AdministrativeDetailsComponent', () => {
    ...
    describe('with AdministrativeDetailsComponent setup', AdministrativeDetailsComponentSetup);
...
let de: DebugElement;
let comp: AdministrativeDetailsComponent;
...
function AdministrativeDetailsComponentSetup() {
    describe('AdministrativeDetailsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AdministrativeDetailsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AdministrativeDetailsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AdministrativeDetailsComponent, {
                set: {
                    providers: [
