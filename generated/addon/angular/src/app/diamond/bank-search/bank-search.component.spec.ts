...
describe('BankSearchComponent', () => {
    ...
    describe('with BankSearchComponent setup', BankSearchComponentSetup);
...
function BankSearchComponentSetup() {
    describe('BankSearchComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('BankSearchComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(BankSearchComponent, {
                set: {
                    providers: [
