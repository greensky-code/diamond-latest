...
describe('IdCardComponent', () => {
    ...
    describe('with IdCardComponent setup', IdCardComponentSetup);
...
function IdCardComponentSetup() {
    describe('IdCardComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('IdCardComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(IdCardComponent, {
                set: {
                    providers: [
