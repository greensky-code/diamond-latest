...
import { PayTheProviderComponent } from './pay-the-provider.component';
...
describe('PayTheProviderComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PayTheProviderComponent setup', PayTheProviderComponentSetup);
...
let de: DebugElement;
let comp: PayTheProviderComponent;
let fixture: ComponentFixture<PayTheProviderComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(PayTheProviderComponent);
...
function PayTheProviderComponentSetup() {
    describe('PayTheProviderComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PayTheProviderComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('PayTheProviderComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PayTheProviderComponent, {
                set: {
                    providers: [
