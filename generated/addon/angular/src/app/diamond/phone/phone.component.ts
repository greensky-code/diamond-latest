...
// Use the Component directive to define the PhoneComponent as an Angular component
//
...
export class PhoneComponent implements OnInit  {
    ...
    ngOnInit(): void {
        ...
        this.createForm();
        this.displayMessage = {};
        this.formValidation = new FormValidation(this.phoneForm);
         this.createDataGrid();
    }
