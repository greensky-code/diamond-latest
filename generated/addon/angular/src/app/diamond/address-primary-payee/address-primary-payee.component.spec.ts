...
import { AddressPrimaryPayeeComponent } from './address-primary-payee.component';
...
describe('AddressPrimaryPayeeComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AddressPrimaryPayeeComponent setup', AddressPrimaryPayeeComponentSetup);
...
let de: DebugElement;
let comp: AddressPrimaryPayeeComponent;
let fixture: ComponentFixture<AddressPrimaryPayeeComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AddressPrimaryPayeeComponent);
...
function AddressPrimaryPayeeComponentSetup() {
    describe('AddressPrimaryPayeeComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AddressPrimaryPayeeComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AddressPrimaryPayeeComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AddressPrimaryPayeeComponent, {
                set: {
                    providers: [
