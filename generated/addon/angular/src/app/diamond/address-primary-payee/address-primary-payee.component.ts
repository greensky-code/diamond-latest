...
// Use the Component directive to define the AddressPrimaryPayeeComponent as an Angular component
//
...
@Component({
    ...
    selector: 'addressprimarypayee',
    templateUrl: './address-primary-payee.component.html',

})
export class AddressPrimaryPayeeComponent implements OnInit  {

    // The form model used by the view per Angular Reactive Forms
    // See: https://angular.io/docs/ts/latest/guide/reactive-forms.html#!#intro
    addressPrimaryPayeeForm: FormGroup;
    ...
    ngOnInit(): void {
        ...
        this.createForm();
        this.displayMessage = {};
        this.formValidation = new FormValidation(this.addressPrimaryPayeeForm);
    }
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.addressPrimaryPayeeForm = this.formBuilder.group({
