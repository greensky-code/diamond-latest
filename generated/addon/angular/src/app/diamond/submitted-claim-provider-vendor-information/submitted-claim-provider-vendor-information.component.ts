...
@Component({
    ...
    selector: 'submittedclaimprovidervendorinformation',
    templateUrl: './submitted-claim-provider-vendor-information.component.html',

})
export class SubmittedClaimProviderVendorInformationComponent implements OnInit  {
