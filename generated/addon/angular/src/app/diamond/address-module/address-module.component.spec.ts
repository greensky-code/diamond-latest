...
describe('AddressModuleComponent', () => {
    ...
    describe('with AddressModuleComponent setup', AddressModuleComponentSetup);
...
let de: DebugElement;
let comp: AddressModuleComponent;
...
function AddressModuleComponentSetup() {
    describe('AddressModuleComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('AddressModuleComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AddressModuleComponent, {
                set: {
                    providers: [
