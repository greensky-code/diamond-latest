...
// Use the Component directive to define the AddressModuleComponent as an Angular component
//
...
@Component({
    ...
    selector: 'addressmodule',
    templateUrl: './address-module.component.html',

})
export class AddressModuleComponent implements OnInit  {

    // The form model used by the view per Angular Reactive Forms
    // See: https://angular.io/docs/ts/latest/guide/reactive-forms.html#!#intro
    addressModuleForm: FormGroup;
    ...
    ngOnInit(): void {
        ...
        this.createForm();
        this.displayMessage = {};
        this.formValidation = new FormValidation(this.addressModuleForm);
...
// Use a FormBuilder to create a FormGroup to define the Form Model for the view
    ...
    createForm() {
        ...
        this.addressModuleForm = this.formBuilder.group({
        }, {updateOn: 'submit'});
    }
