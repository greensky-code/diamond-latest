...
import { AddressCignaLinkGroupAddressComponent } from './address-cigna-link-group-address.component';
...
describe('AddressCignaLinkGroupAddressComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AddressCignaLinkGroupAddressComponent setup', AddressCignaLinkGroupAddressComponentSetup);
...
let de: DebugElement;
let comp: AddressCignaLinkGroupAddressComponent;
let fixture: ComponentFixture<AddressCignaLinkGroupAddressComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AddressCignaLinkGroupAddressComponent);
...
function AddressCignaLinkGroupAddressComponentSetup() {
    describe('AddressCignaLinkGroupAddressComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AddressCignaLinkGroupAddressComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AddressCignaLinkGroupAddressComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AddressCignaLinkGroupAddressComponent, {
                set: {
                    providers: [
