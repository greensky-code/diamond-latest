...
import 'rxjs/add/operator/map';
import { GetProvinceDetails } from '../api-models/get-province-details.input-model'
import { GetProvinceDetailsViewModel } from '../api-models/get-province-details.view-model'
...
@Injectable()
export class GetProvinceDetailsService {

    private getProvinceDetailsUrl: string = `${environment.apiUrl}/getprovincedetail`;
    ...
    getProvinceDetails(getProvinceDetails : GetProvinceDetails): Promise<GetProvinceDetailsViewModel[]> {
        let body = JSON.stringify(getProvinceDetails);
        return this.httpClient.post(this.getProvinceDetailsUrl, body, { headers: this.contentHeaders })
            .toPromise()
