...
describe('CiebGroupMasterService', () => {
  ...
  describe('#getCiebGroupMasters', () => {
    it('should return an Promise<CiebGroupMaster[]>', () => {
      const ciebGroupMaster = [
       {seqGroupId:1234, hsdGroupId:'sample data', rxprimeClientId:'sample data', rxprimeExtractFlag:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data'},
       {seqGroupId:1234, hsdGroupId:'sample data', rxprimeClientId:'sample data', rxprimeExtractFlag:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data'},
       {seqGroupId:1234, hsdGroupId:'sample data', rxprimeClientId:'sample data', rxprimeExtractFlag:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data'}
  ...
  describe('#createCiebGroupMaster', () => {
    var id = 1;
    it('should return an Promise<CiebGroupMaster>', () => {
      const ciebGroupMaster: CiebGroupMaster = {seqGroupId:1234, hsdGroupId:'sample data', rxprimeClientId:'sample data', rxprimeExtractFlag:'sample data', insertDatetime:'2018-01-01', insertUser:'sample data', insertProcess:'sample data', updateDatetime:'2018-01-01', updateUser:'sample data', updateProcess:'sample data'};
