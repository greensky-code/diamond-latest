...
import 'rxjs/add/operator/map';
import { ProcSaveMigrationDetails } from '../api-models/proc-save-migration-details.input-model'
import { ProcSaveMigrationDetailsViewModel } from '../api-models/proc-save-migration-details.view-model'
...
@Injectable()
export class ProcSaveMigrationDetailsService {

    private procSaveMigrationDetailsUrl: string = `${environment.apiUrl}/procsavemigrationdetail`;
    ...
    procSaveMigrationDetails(procSaveMigrationDetails : ProcSaveMigrationDetails): Promise<ProcSaveMigrationDetailsViewModel[]> {
        let body = JSON.stringify(procSaveMigrationDetails);
        return this.httpClient.post(this.procSaveMigrationDetailsUrl, body, { headers: this.contentHeaders })
            .toPromise()
