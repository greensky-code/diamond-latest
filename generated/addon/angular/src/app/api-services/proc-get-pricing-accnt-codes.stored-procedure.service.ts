...
import 'rxjs/add/operator/map';
import { ProcGetPricingAccntCodes } from '../api-models/proc-get-pricing-accnt-codes.input-model'
import { ProcGetPricingAccntCodesViewModel } from '../api-models/proc-get-pricing-accnt-codes.view-model'
...
export class ProcGetPricingAccntCodesService {
    ...
    private procGetPricingAccntCodesUrl: string = `${environment.apiUrl}/procgetpricingaccntcode`;
    ...
    procGetPricingAccntCodes(procGetPricingAccntCodes : ProcGetPricingAccntCodes): Promise<ProcGetPricingAccntCodesViewModel[]> {
        let body = JSON.stringify(procGetPricingAccntCodes);
        return this.httpClient.post(this.procGetPricingAccntCodesUrl, body, { headers: this.contentHeaders })
            .toPromise()
