...
describe('GetProvinceDetailsService', () => {
  ...
  describe('#getGetProvinceDetail', () => {
    it('should return an Promise<GetProvinceDetails[]>', () => {
      const getProvinceDetails = [
       {pTaxRegion:'sample data', pTaxType:'sample data', pTaxProduct:'sample data', pFundType:'sample data', pTaxPercent:1234, pEffDate:'sample data', pTermDate:'sample data', pProvinceEffDate:'sample data', pTermReasonCode:'sample data', pApplyRetro:'sample data'},
       {pTaxRegion:'sample data', pTaxType:'sample data', pTaxProduct:'sample data', pFundType:'sample data', pTaxPercent:1234, pEffDate:'sample data', pTermDate:'sample data', pProvinceEffDate:'sample data', pTermReasonCode:'sample data', pApplyRetro:'sample data'},
       {pTaxRegion:'sample data', pTaxType:'sample data', pTaxProduct:'sample data', pFundType:'sample data', pTaxPercent:1234, pEffDate:'sample data', pTermDate:'sample data', pProvinceEffDate:'sample data', pTermReasonCode:'sample data', pApplyRetro:'sample data'}
  ...
  describe('#createGetProvinceDetails', () => {
    var id = 1;
    it('should return an Promise<GetProvinceDetails>', () => {
      const getProvinceDetails: GetProvinceDetails = {pTaxRegion:'sample data', pTaxType:'sample data', pTaxProduct:'sample data', pFundType:'sample data', pTaxPercent:1234, pEffDate:'sample data', pTermDate:'sample data', pProvinceEffDate:'sample data', pTermReasonCode:'sample data', pApplyRetro:'sample data'};
