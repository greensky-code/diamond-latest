...
import 'rxjs/add/operator/map';
import { ProcGetGroupTestStatus } from '../api-models/proc-get-group-test-status.input-model'
import { ProcGetGroupTestStatusViewModel } from '../api-models/proc-get-group-test-status.view-model'
...
@Injectable()
export class ProcGetGroupTestStatusService {

    private procGetGroupTestStatusUrl: string = `${environment.apiUrl}/procgetgroupteststatu`;
    ...
    procGetGroupTestStatus(procGetGroupTestStatus : ProcGetGroupTestStatus): Promise<ProcGetGroupTestStatusViewModel[]> {
        let body = JSON.stringify(procGetGroupTestStatus);
        return this.httpClient.post(this.procGetGroupTestStatusUrl, body, { headers: this.contentHeaders })
            .toPromise()
