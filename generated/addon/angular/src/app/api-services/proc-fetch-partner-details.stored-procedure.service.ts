...
import 'rxjs/add/operator/map';
import { ProcFetchPartnerDetails } from '../api-models/proc-fetch-partner-details.input-model'
import { ProcFetchPartnerDetailsViewModel } from '../api-models/proc-fetch-partner-details.view-model'
