...
import { ProviderIncentiveProgramRuleComponent } from './provider-incentive-program-rule.component';
...
describe('ProviderIncentiveProgramRuleComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ProviderIncentiveProgramRuleComponent setup', ProviderIncentiveProgramRuleComponentSetup);
...
let de: DebugElement;
let comp: ProviderIncentiveProgramRuleComponent;
let fixture: ComponentFixture<ProviderIncentiveProgramRuleComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ProviderIncentiveProgramRuleComponent);
...
function ProviderIncentiveProgramRuleComponentSetup() {
    describe('ProviderIncentiveProgramRuleComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ProviderIncentiveProgramRuleComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ProviderIncentiveProgramRuleComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ProviderIncentiveProgramRuleComponent, {
                set: {
                    providers: [
