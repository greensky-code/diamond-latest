...
import { DrgInformationComponent } from './drg-information.component';
...
describe('DrgInformationComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with DrgInformationComponent setup', DrgInformationComponentSetup);
...
let de: DebugElement;
let comp: DrgInformationComponent;
let fixture: ComponentFixture<DrgInformationComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(DrgInformationComponent);
...
function DrgInformationComponentSetup() {
    describe('DrgInformationComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [DrgInformationComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('DrgInformationComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(DrgInformationComponent, {
                set: {
                    providers: [
