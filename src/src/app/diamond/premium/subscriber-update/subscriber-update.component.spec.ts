...
describe('SubscriberUpdateComponent', () => {
    ...
    describe('with SubscriberUpdateComponent setup', SubscriberUpdateComponentSetup);
...
function SubscriberUpdateComponentSetup() {
    describe('SubscriberUpdateComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('SubscriberUpdateComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(SubscriberUpdateComponent, {
                set: {
                    providers: [
