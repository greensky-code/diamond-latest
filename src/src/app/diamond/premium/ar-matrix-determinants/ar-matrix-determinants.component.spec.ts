...
import { ArMatrixDeterminantsComponent } from './ar-matrix-determinants.component';
...
describe('ArMatrixDeterminantsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ArMatrixDeterminantsComponent setup', ArMatrixDeterminantsComponentSetup);
...
let de: DebugElement;
let comp: ArMatrixDeterminantsComponent;
let fixture: ComponentFixture<ArMatrixDeterminantsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ArMatrixDeterminantsComponent);
...
function ArMatrixDeterminantsComponentSetup() {
    describe('ArMatrixDeterminantsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ArMatrixDeterminantsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ArMatrixDeterminantsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ArMatrixDeterminantsComponent, {
                set: {
                    providers: [
