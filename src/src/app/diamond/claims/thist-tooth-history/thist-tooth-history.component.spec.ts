...
import { ThistToothHistoryComponent } from './thist-tooth-history.component';
...
describe('ThistToothHistoryComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ThistToothHistoryComponent setup', ThistToothHistoryComponentSetup);
...
let de: DebugElement;
let comp: ThistToothHistoryComponent;
let fixture: ComponentFixture<ThistToothHistoryComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ThistToothHistoryComponent);
...
function ThistToothHistoryComponentSetup() {
    describe('ThistToothHistoryComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ThistToothHistoryComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ThistToothHistoryComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ThistToothHistoryComponent, {
                set: {
                    providers: [
