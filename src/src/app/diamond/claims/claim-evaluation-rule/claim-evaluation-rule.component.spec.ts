...
import { ClaimEvaluationRuleComponent } from './claim-evaluation-rule.component';
...
describe('ClaimEvaluationRuleComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimEvaluationRuleComponent setup', ClaimEvaluationRuleComponentSetup);
...
let de: DebugElement;
let comp: ClaimEvaluationRuleComponent;
let fixture: ComponentFixture<ClaimEvaluationRuleComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimEvaluationRuleComponent);
...
function ClaimEvaluationRuleComponentSetup() {
    describe('ClaimEvaluationRuleComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimEvaluationRuleComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimEvaluationRuleComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimEvaluationRuleComponent, {
                set: {
                    providers: [
