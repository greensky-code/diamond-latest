...
import { ClaimsBatchInitiationComponent } from './claims-batch-initiation.component';
...
describe('ClaimsBatchInitiationComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimsBatchInitiationComponent setup', ClaimsBatchInitiationComponentSetup);
...
let de: DebugElement;
let comp: ClaimsBatchInitiationComponent;
let fixture: ComponentFixture<ClaimsBatchInitiationComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimsBatchInitiationComponent);
...
function ClaimsBatchInitiationComponentSetup() {
    describe('ClaimsBatchInitiationComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimsBatchInitiationComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimsBatchInitiationComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimsBatchInitiationComponent, {
                set: {
                    providers: [
