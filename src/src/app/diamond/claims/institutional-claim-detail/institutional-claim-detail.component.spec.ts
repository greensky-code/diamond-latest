...
import { InstitutionalClaimDetailComponent } from './institutional-claim-detail.component';
...
describe('HeaderFileComponent', () => {
    ...
    describe('with InstitutionalClaimDetailComponent setup', HeaderFileComponentSetup);
...
let de: DebugElement;
let comp: InstitutionalClaimDetailComponent;
let fixture: ComponentFixture<InstitutionalClaimDetailComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(InstitutionalClaimDetailComponent);
...
function HeaderFileComponentSetup() {
    describe('HeaderFileComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [InstitutionalClaimDetailComponent]
            })
                .compileComponents()
    ...
    describe('HeaderFileComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                .overrideComponent(InstitutionalClaimDetailComponent, {
                    set: {
                        providers: [
