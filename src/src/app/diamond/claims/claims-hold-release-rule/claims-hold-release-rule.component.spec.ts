...
import { ClaimsHoldReleaseRuleComponent } from './claims-hold-release-rule.component';
...
describe('ClaimsHoldReleaseRuleComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimsHoldReleaseRuleComponent setup', ClaimsHoldReleaseRuleComponentSetup);
...
let de: DebugElement;
let comp: ClaimsHoldReleaseRuleComponent;
let fixture: ComponentFixture<ClaimsHoldReleaseRuleComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimsHoldReleaseRuleComponent);
...
function ClaimsHoldReleaseRuleComponentSetup() {
    describe('ClaimsHoldReleaseRuleComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimsHoldReleaseRuleComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimsHoldReleaseRuleComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimsHoldReleaseRuleComponent, {
                set: {
                    providers: [
