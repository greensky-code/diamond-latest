...
import { HoldDenyDeterminantsComponent } from './hold-deny-determinants.component';
...
describe('HoldDenyDeterminantsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with HoldDenyDeterminantsComponent setup', HoldDenyDeterminantsComponentSetup);
...
let de: DebugElement;
let comp: HoldDenyDeterminantsComponent;
let fixture: ComponentFixture<HoldDenyDeterminantsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(HoldDenyDeterminantsComponent);
...
function HoldDenyDeterminantsComponentSetup() {
    describe('HoldDenyDeterminantsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [HoldDenyDeterminantsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('HoldDenyDeterminantsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(HoldDenyDeterminantsComponent, {
                set: {
                    providers: [
