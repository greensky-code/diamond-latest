...
import { ClaimAuthProcLinkComponent } from './claim-auth-proc-link.component';
...
describe('ClaimAuthProcLinkComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimAuthProcLinkComponent setup', ClaimAuthProcLinkComponentSetup);
...
let de: DebugElement;
let comp: ClaimAuthProcLinkComponent;
let fixture: ComponentFixture<ClaimAuthProcLinkComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimAuthProcLinkComponent);
...
function ClaimAuthProcLinkComponentSetup() {
    describe('ClaimAuthProcLinkComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimAuthProcLinkComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimAuthProcLinkComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimAuthProcLinkComponent, {
                set: {
                    providers: [
