...
import { ProfessionalServicesClaimsOtherComponent } from './professional-services-claims-other.component';
...
describe('ProfessionalServicesClaimsOtherComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ProfessionalServicesClaimsOtherComponent setup', ProfessionalServicesClaimsOtherComponentSetup);
...
let de: DebugElement;
let comp: ProfessionalServicesClaimsOtherComponent;
let fixture: ComponentFixture<ProfessionalServicesClaimsOtherComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ProfessionalServicesClaimsOtherComponent);
...
function ProfessionalServicesClaimsOtherComponentSetup() {
    describe('ProfessionalServicesClaimsOtherComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ProfessionalServicesClaimsOtherComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ProfessionalServicesClaimsOtherComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ProfessionalServicesClaimsOtherComponent, {
                set: {
                    providers: [
