...
describe('ClaimDisplayComponent', () => {
    ...
    describe('with ClaimDisplayComponent setup', ClaimDisplayComponentSetup);
...
let de: DebugElement;
let comp: ClaimDisplayComponent;
...
function ClaimDisplayComponentSetup() {
    describe('ClaimDisplayComponent', function () {
        beforeEach(async(() => {
    ...
    describe('ClaimDisplayComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                .overrideComponent(ClaimDisplayComponent, {
                    set: {
                        providers: [
