...
import { DentalServiceClaimsComponent } from './dental-service-claims.component';
...
describe('DentalServiceClaimsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with DentalServiceClaimsComponent setup', DentalServiceClaimsComponentSetup);
...
let de: DebugElement;
let comp: DentalServiceClaimsComponent;
let fixture: ComponentFixture<DentalServiceClaimsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(DentalServiceClaimsComponent);
...
function DentalServiceClaimsComponentSetup() {
    describe('DentalServiceClaimsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [DentalServiceClaimsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('DentalServiceClaimsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(DentalServiceClaimsComponent, {
                set: {
                    providers: [
