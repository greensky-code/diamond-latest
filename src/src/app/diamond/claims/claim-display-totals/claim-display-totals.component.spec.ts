...
import { ClaimDisplayTotalsComponent } from './claim-display-totals.component';
...
describe('ClaimDisplayTotalsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimDisplayTotalsComponent setup', ClaimDisplayTotalsComponentSetup);
...
let de: DebugElement;
let comp: ClaimDisplayTotalsComponent;
let fixture: ComponentFixture<ClaimDisplayTotalsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimDisplayTotalsComponent);
...
function ClaimDisplayTotalsComponentSetup() {
    describe('ClaimDisplayTotalsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimDisplayTotalsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimDisplayTotalsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimDisplayTotalsComponent, {
                set: {
                    providers: [
