...
import { MemberUtilizationDisplayComponent } from './member-utilization-display.component';
...
describe('MemberUtilizationDisplayComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with MemberUtilizationDisplayComponent setup', MemberUtilizationDisplayComponentSetup);
...
let de: DebugElement;
let comp: MemberUtilizationDisplayComponent;
let fixture: ComponentFixture<MemberUtilizationDisplayComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(MemberUtilizationDisplayComponent);
...
function MemberUtilizationDisplayComponentSetup() {
    describe('MemberUtilizationDisplayComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MemberUtilizationDisplayComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MemberUtilizationDisplayComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MemberUtilizationDisplayComponent, {
                set: {
                    providers: [
