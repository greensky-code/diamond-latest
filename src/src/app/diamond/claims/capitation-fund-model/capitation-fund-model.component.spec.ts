...
import { CapitationFundModelComponent } from './capitation-fund-model.component';
...
describe('CapitationFundModelComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with CapitationFundModelComponent setup', CapitationFundModelComponentSetup);
...
let de: DebugElement;
let comp: CapitationFundModelComponent;
let fixture: ComponentFixture<CapitationFundModelComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(CapitationFundModelComponent);
...
function CapitationFundModelComponentSetup() {
    describe('CapitationFundModelComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CapitationFundModelComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('CapitationFundModelComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(CapitationFundModelComponent, {
                set: {
                    providers: [
