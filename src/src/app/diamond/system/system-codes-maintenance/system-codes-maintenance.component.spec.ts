...
import { SystemCodesMaintenanceComponent } from './system-codes-maintenance.component';
...
describe('SystemCodesMaintenanceComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with SystemCodesMaintenanceComponent setup', SystemCodesMaintenanceComponentSetup);
...
let de: DebugElement;
let comp: SystemCodesMaintenanceComponent;
let fixture: ComponentFixture<SystemCodesMaintenanceComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(SystemCodesMaintenanceComponent);
...
function SystemCodesMaintenanceComponentSetup() {
    describe('SystemCodesMaintenanceComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [SystemCodesMaintenanceComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('SystemCodesMaintenanceComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(SystemCodesMaintenanceComponent, {
                set: {
                    providers: [
