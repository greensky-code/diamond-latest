...
import { AddressRippleComponent } from './address-ripple.component';
...
describe('AddressRippleComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AddressRippleComponent setup', AddressRippleComponentSetup);
...
let de: DebugElement;
let comp: AddressRippleComponent;
let fixture: ComponentFixture<AddressRippleComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AddressRippleComponent);
...
function AddressRippleComponentSetup() {
    describe('AddressRippleComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AddressRippleComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AddressRippleComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AddressRippleComponent, {
                set: {
                    providers: [
