...
import {GroupUserFieldsComponent} from './group-user-fields.component';
...
describe('GroupUserFieldsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with GroupUserFieldsComponent setup', GroupUserFieldsComponentSetup);
...
let de: DebugElement;
let comp: GroupUserFieldsComponent;
let fixture: ComponentFixture<GroupUserFieldsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(GroupUserFieldsComponent);
...
function GroupUserFieldsComponentSetup() {
    describe('GroupUserFieldsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [GroupUserFieldsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('GroupUserFieldsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(GroupUserFieldsComponent, {
                set: {
                    providers: [
