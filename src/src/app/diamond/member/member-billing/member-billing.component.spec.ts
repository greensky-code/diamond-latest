...
import { MemberBillingComponent } from './member-billing.component';
...
describe('MemberBillingComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with MemberBillingComponent setup', MemberBillingComponentSetup);
...
let de: DebugElement;
let comp: MemberBillingComponent;
let fixture: ComponentFixture<MemberBillingComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(MemberBillingComponent);
...
function MemberBillingComponentSetup() {
    describe('MemberBillingComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MemberBillingComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MemberBillingComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MemberBillingComponent, {
                set: {
                    providers: [
