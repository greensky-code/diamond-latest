...
describe('LetterRequestComponent', () => {
    ...
    describe('with LetterRequestComponent setup', LetterRequestComponentSetup);
...
let de: DebugElement;
let comp: LetterRequestComponent;
...
function LetterRequestComponentSetup() {
    describe('LetterRequestComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('LetterRequestComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(LetterRequestComponent, {
                set: {
                    providers: [
