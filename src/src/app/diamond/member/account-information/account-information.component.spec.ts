...
describe('AccountInformationComponent', () => {
    ...
    describe('with AccountInformationComponent setup', AccountInformationComponentSetup);
...
function AccountInformationComponentSetup() {
    describe('AccountInformationComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('AccountInformationComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AccountInformationComponent, {
                set: {
                    providers: [
