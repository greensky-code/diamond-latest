...
import {AlternateSearchColumnsComponent} from './alternate-search-columns.component';
...
describe('AlternateSearchColumnsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AlternateSearchColumnsComponent setup', AlternateSearchColumnsComponentSetup);
...
let de: DebugElement;
let comp: AlternateSearchColumnsComponent;
let fixture: ComponentFixture<AlternateSearchColumnsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AlternateSearchColumnsComponent);
...
function AlternateSearchColumnsComponentSetup() {
    describe('AlternateSearchColumnsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AlternateSearchColumnsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AlternateSearchColumnsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AlternateSearchColumnsComponent, {
                set: {
                    providers: [
