...
import { IdCardPrintComponent } from './id-card-print.component';
...
describe('IdCardPrintComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with IdCardPrintComponent setup', IdCardPrintComponentSetup);
...
let de: DebugElement;
let comp: IdCardPrintComponent;
let fixture: ComponentFixture<IdCardPrintComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(IdCardPrintComponent);
...
function IdCardPrintComponentSetup() {
    describe('IdCardPrintComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [IdCardPrintComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('IdCardPrintComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(IdCardPrintComponent, {
                set: {
                    providers: [
