...
import { AccumClaimsReportComponent } from './accum-claims-report.component';
...
describe('AccumClaimsReportComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AccumClaimsReportComponent setup', AccumClaimsReportComponentSetup);
...
let de: DebugElement;
let comp: AccumClaimsReportComponent;
let fixture: ComponentFixture<AccumClaimsReportComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AccumClaimsReportComponent);
...
function AccumClaimsReportComponentSetup() {
    describe('AccumClaimsReportComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AccumClaimsReportComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AccumClaimsReportComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AccumClaimsReportComponent, {
                set: {
                    providers: [
