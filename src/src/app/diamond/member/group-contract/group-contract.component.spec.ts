...
describe('GroupContractComponent', () => {
    ...
    describe('with GroupContractComponent setup', GroupContractComponentSetup);
...
let de: DebugElement;
let comp: GroupContractComponent;
...
function GroupContractComponentSetup() {
    describe('GroupContractComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('GroupContractComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(GroupContractComponent, {
                set: {
                    providers: [
