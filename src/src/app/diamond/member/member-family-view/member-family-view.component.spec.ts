...
import {MemberFamilyViewComponent} from './member-family-view.component';
...
describe('MemberFamilyViewComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with MemberFamilyViewComponent setup', ChangeMemberFamilyViewComponentSetup);
...
let de: DebugElement;
let comp: MemberFamilyViewComponent;
let fixture: ComponentFixture<MemberFamilyViewComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(MemberFamilyViewComponent);
...
function ChangeMemberFamilyViewComponentSetup() {
    describe('MemberFamilyViewComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MemberFamilyViewComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MemberFamilyViewComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(MemberFamilyViewComponent, {
                set: {
                    providers: [
