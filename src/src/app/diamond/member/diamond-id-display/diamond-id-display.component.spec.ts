...
import {DiamondIdDisplayComponent} from './diamond-id-display.component';
...
describe('MemberFamilyViewComponent', () => {
    ...
    describe('with DiamondIdDisplayComponent setup', ChangeDiamondIdDisplayComponentSetUp);
...
let de: DebugElement;
let comp: DiamondIdDisplayComponent;
let fixture: ComponentFixture<DiamondIdDisplayComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(DiamondIdDisplayComponent);
...
function ChangeDiamondIdDisplayComponentSetUp() {
    describe('MemberFamilyViewComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [DiamondIdDisplayComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('MemberFamilyViewComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(DiamondIdDisplayComponent, {
                set: {
                    providers: [
