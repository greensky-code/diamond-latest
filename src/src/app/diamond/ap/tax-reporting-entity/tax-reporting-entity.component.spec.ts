...
import { TaxReportingEntityComponent } from './tax-reporting-entity.component';
...
describe('TaxReportingEntityComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with TaxReportingEntityComponent setup', TaxReportingEntityComponentSetup);
...
let de: DebugElement;
let comp: TaxReportingEntityComponent;
let fixture: ComponentFixture<TaxReportingEntityComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(TaxReportingEntityComponent);
...
function TaxReportingEntityComponentSetup() {
    describe('TaxReportingEntityComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [TaxReportingEntityComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('TaxReportingEntityComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(TaxReportingEntityComponent, {
                set: {
                    providers: [
