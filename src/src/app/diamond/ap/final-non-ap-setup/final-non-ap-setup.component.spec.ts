...
import { FinalNonApSetupComponent } from './final-non-ap-setup.component';
...
describe('FinalNonApSetupComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with FinalNonApSetupComponent setup', FinalNonApSetupComponentSetup);
...
let de: DebugElement;
let comp: FinalNonApSetupComponent;
let fixture: ComponentFixture<FinalNonApSetupComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(FinalNonApSetupComponent);
...
function FinalNonApSetupComponentSetup() {
    describe('FinalNonApSetupComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [FinalNonApSetupComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('FinalNonApSetupComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(FinalNonApSetupComponent, {
                set: {
                    providers: [
