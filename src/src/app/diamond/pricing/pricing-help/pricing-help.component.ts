...
@Component({
    selector: 'pricing-help',
    templateUrl: './pricing-help.component.html',
})
export class PricingHelpComponent implements OnInit {


    @Input() showIcon;
    baseUrl = '../../../../../assets/help';
    @Input() defaultFile = '/Pricing_Anesthesia_Time_How_DIAMOND_Thinks.htm';
    selectedPage = null;
