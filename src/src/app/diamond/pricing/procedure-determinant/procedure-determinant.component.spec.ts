...
import { ProcedureDeterminantComponent } from './procedure-determinant.component';
...
describe('ProcedureDeterminantComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ProcedureDeterminantComponent setup', ProcedureDeterminantComponentSetup);
...
let de: DebugElement;
let comp: ProcedureDeterminantComponent;
let fixture: ComponentFixture<ProcedureDeterminantComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ProcedureDeterminantComponent);
...
function ProcedureDeterminantComponentSetup() {
    describe('ProcedureDeterminantComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ProcedureDeterminantComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ProcedureDeterminantComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ProcedureDeterminantComponent, {
                set: {
                    providers: [
