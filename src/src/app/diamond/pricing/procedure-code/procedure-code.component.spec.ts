...
describe('ProcedureCodeComponent', () => {
    ...
    describe('with ProcedureCodeComponent setup', ProcedureCodeComponentSetup);
...
let de: DebugElement;
let comp: ProcedureCodeComponent;
...
function ProcedureCodeComponentSetup() {
    describe('ProcedureCodeComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('ProcedureCodeComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ProcedureCodeComponent, {
                set: {
                    providers: [
