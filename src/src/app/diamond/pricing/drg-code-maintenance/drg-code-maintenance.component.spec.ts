...
import { DrgCodeMaintenanceComponent } from './drg-code-maintenance.component';
...
describe('DrgCodeMaintenanceComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with DrgCodeMaintenanceComponent setup', DrgCodeMaintenanceComponentSetup);
...
let de: DebugElement;
let comp: DrgCodeMaintenanceComponent;
let fixture: ComponentFixture<DrgCodeMaintenanceComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(DrgCodeMaintenanceComponent);
...
function DrgCodeMaintenanceComponentSetup() {
    describe('DrgCodeMaintenanceComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [DrgCodeMaintenanceComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('DrgCodeMaintenanceComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(DrgCodeMaintenanceComponent, {
                set: {
                    providers: [
