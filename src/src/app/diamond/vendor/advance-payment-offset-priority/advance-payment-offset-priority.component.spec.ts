...
import { AdvancePaymentOffsetPriorityComponent } from './advance-payment-offset-priority.component';
...
describe('AdvancePaymentOffsetPriorityComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AdvancePaymentOffsetPriorityComponent setup', AdvancePaymentOffsetPriorityComponentSetup);
...
let de: DebugElement;
let comp: AdvancePaymentOffsetPriorityComponent;
let fixture: ComponentFixture<AdvancePaymentOffsetPriorityComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AdvancePaymentOffsetPriorityComponent);
...
function AdvancePaymentOffsetPriorityComponentSetup() {
    describe('AdvancePaymentOffsetPriorityComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AdvancePaymentOffsetPriorityComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AdvancePaymentOffsetPriorityComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AdvancePaymentOffsetPriorityComponent, {
                set: {
                    providers: [
