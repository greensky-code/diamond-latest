...
import { DefineBenefitValueFiltersComponent } from './define-benefit-value-filters.component';
...
describe('DefineBenefitValueFiltersComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with DefineBenefitValueFiltersComponent setup', DefineBenefitValueFiltersComponentSetup);
...
let de: DebugElement;
let comp: DefineBenefitValueFiltersComponent;
let fixture: ComponentFixture<DefineBenefitValueFiltersComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(DefineBenefitValueFiltersComponent);
...
function DefineBenefitValueFiltersComponentSetup() {
    describe('DefineBenefitValueFiltersComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [DefineBenefitValueFiltersComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('DefineBenefitValueFiltersComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(DefineBenefitValueFiltersComponent, {
                set: {
                    providers: [
