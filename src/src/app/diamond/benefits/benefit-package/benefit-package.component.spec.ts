...
import {BenefitPackageComponent} from './benefit-package.component';
...
describe('BenefitPackageComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with BenefitPackageComponent setup', BenefitPackageComponentSetup);
...
let de: DebugElement;
let comp: BenefitPackageComponent;
let fixture: ComponentFixture<BenefitPackageComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(BenefitPackageComponent);
...
function BenefitPackageComponentSetup() {
    describe('BenefitPackageComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [BenefitPackageComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('BenefitPackageComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(BenefitPackageComponent, {
                set: {
                    providers: [
