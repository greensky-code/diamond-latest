...
@Component({
    ...
    templateUrl: './benefits-help.component.html',
    styleUrls: ['./benefits-help.component.scss']
})
export class BenefitsHelpComponent implements OnInit {
    public subActiveTab = 1;
    baseUrl = '../../../../../assets/help';

    @Input() showIcon = true;
    @Input() defaultFile = '/Copying_a_Benefit_Package.htm';
    selectedPage = null;
