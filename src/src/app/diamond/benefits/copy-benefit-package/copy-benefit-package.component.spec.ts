...
import { CopyBenefitPackageComponent } from './copy-benefit-package.component';
...
describe('CopyBenefitPackageComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with CopyBenefitPackageComponent setup', CopyBenefitPackageComponentSetup);
...
let de: DebugElement;
let comp: CopyBenefitPackageComponent;
let fixture: ComponentFixture<CopyBenefitPackageComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(CopyBenefitPackageComponent);
...
function CopyBenefitPackageComponentSetup() {
    describe('CopyBenefitPackageComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CopyBenefitPackageComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('CopyBenefitPackageComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(CopyBenefitPackageComponent, {
                set: {
                    providers: [
