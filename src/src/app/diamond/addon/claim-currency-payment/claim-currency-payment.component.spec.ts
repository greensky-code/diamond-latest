...
import { ClaimCurrencyPaymentComponent } from './claim-currency-payment.component';
...
describe('ClaimCurrencyPaymentComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimCurrencyPaymentComponent setup', ClaimCurrencyPaymentComponentSetup);
...
let de: DebugElement;
let comp: ClaimCurrencyPaymentComponent;
let fixture: ComponentFixture<ClaimCurrencyPaymentComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimCurrencyPaymentComponent);
...
function ClaimCurrencyPaymentComponentSetup() {
    describe('ClaimCurrencyPaymentComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimCurrencyPaymentComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimCurrencyPaymentComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimCurrencyPaymentComponent, {
                set: {
                    providers: [
