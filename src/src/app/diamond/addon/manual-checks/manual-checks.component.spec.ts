...
describe('ManualChecksComponent', () => {
    ...
    describe('with ManualChecksComponent setup', ManualChecksComponentSetup);
...
let de: DebugElement;
let comp: ManualChecksComponent;
...
function ManualChecksComponentSetup() {
    describe('ManualChecksComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('ManualChecksComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ManualChecksComponent, {
                set: {
                    providers: [
