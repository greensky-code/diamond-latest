...
import { AddressBankSearchComponent } from './address-bank-search.component';
...
describe('AddressBankSearchComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AddressBankSearchComponent setup', AddressBankSearchComponentSetup);
...
let de: DebugElement;
let comp: AddressBankSearchComponent;
let fixture: ComponentFixture<AddressBankSearchComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AddressBankSearchComponent);
...
function AddressBankSearchComponentSetup() {
    describe('AddressBankSearchComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AddressBankSearchComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AddressBankSearchComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AddressBankSearchComponent, {
                set: {
                    providers: [
