...
import { ProviceTaxDetailComponent } from './provice-tax-detail.component';
...
describe('ProviceTaxDetailComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ProviceTaxDetailComponent setup', ProviceTaxDetailComponentSetup);
...
let de: DebugElement;
let comp: ProviceTaxDetailComponent;
let fixture: ComponentFixture<ProviceTaxDetailComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ProviceTaxDetailComponent);
...
function ProviceTaxDetailComponentSetup() {
    describe('ProviceTaxDetailComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ProviceTaxDetailComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ProviceTaxDetailComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ProviceTaxDetailComponent, {
                set: {
                    providers: [
