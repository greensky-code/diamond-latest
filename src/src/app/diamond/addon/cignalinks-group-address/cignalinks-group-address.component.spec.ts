...
import { CignalinksGroupAddressComponent } from './cignalinks-group-address.component';
...
describe('CignalinksGroupAddressComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with CignalinksGroupAddressComponent setup', CignalinksGroupAddressComponentSetup);
...
let de: DebugElement;
let comp: CignalinksGroupAddressComponent;
let fixture: ComponentFixture<CignalinksGroupAddressComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(CignalinksGroupAddressComponent);
...
function CignalinksGroupAddressComponentSetup() {
    describe('CignalinksGroupAddressComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [CignalinksGroupAddressComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('CignalinksGroupAddressComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(CignalinksGroupAddressComponent, {
                set: {
                    providers: [
