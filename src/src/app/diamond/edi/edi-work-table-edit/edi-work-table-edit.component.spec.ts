...
import { EdiWorkTableEditComponent } from './edi-work-table-edit.component';
...
describe('EdiWorkTableEditComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with EdiWorkTableEditComponent setup', EdiWorkTableEditComponentSetup);
...
let de: DebugElement;
let comp: EdiWorkTableEditComponent;
let fixture: ComponentFixture<EdiWorkTableEditComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(EdiWorkTableEditComponent);
...
function EdiWorkTableEditComponentSetup() {
    describe('EdiWorkTableEditComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [EdiWorkTableEditComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('EdiWorkTableEditComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(EdiWorkTableEditComponent, {
                set: {
                    providers: [
