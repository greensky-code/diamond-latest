...
import { TradingPartnerMasterComponent } from './trading-partner-master.component';
...
describe('TradingPartnerMasterComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with TradingPartnerMasterComponent setup', TradingPartnerMasterComponentSetup);
...
let de: DebugElement;
let comp: TradingPartnerMasterComponent;
let fixture: ComponentFixture<TradingPartnerMasterComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(TradingPartnerMasterComponent);
...
function TradingPartnerMasterComponentSetup() {
    describe('TradingPartnerMasterComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [TradingPartnerMasterComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('TradingPartnerMasterComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(TradingPartnerMasterComponent, {
                set: {
                    providers: [
