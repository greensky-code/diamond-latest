...
import { SubmitterMasterComponent } from './submitter-master.component';
...
describe('SubmitterMasterComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with SubmitterMasterComponent setup', SubmitterMasterComponentSetup);
...
let de: DebugElement;
let comp: SubmitterMasterComponent;
let fixture: ComponentFixture<SubmitterMasterComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(SubmitterMasterComponent);
...
function SubmitterMasterComponentSetup() {
    describe('SubmitterMasterComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [SubmitterMasterComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('SubmitterMasterComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(SubmitterMasterComponent, {
                set: {
                    providers: [
