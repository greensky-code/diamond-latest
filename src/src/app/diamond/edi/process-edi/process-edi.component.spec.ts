...
describe('ProcessEditComponent', () => {
    ...
    describe('with ProcessEditComponent setup', ProcessEditComponentSetup);
...
function ProcessEditComponentSetup() {
    describe('ProcessEditComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('ProcessEditComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ProcessEditComponent, {
                set: {
                    providers: [
