...
describe('LineOfBusinessComponent', () => {
    ...
    describe('with LineOfBusinessComponent setup', LineOfBusinessComponentSetup);
...
let de: DebugElement;
let comp: LineOfBusinessComponent;
...
function LineOfBusinessComponentSetup() {
    describe('LineOfBusinessComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('LineOfBusinessComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(LineOfBusinessComponent, {
                set: {
                    providers: [
