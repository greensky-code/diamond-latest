...
describe('LanguageSelectComponent', () => {
    ...
    describe('with LanguageSelectComponent setup', LanguageSelectComponentSetup);
...
let de: DebugElement;
let comp: LanguageSelectComponent;
...
function LanguageSelectComponentSetup() {
    describe('LanguageSelectComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('LanguageSelectComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(LanguageSelectComponent, {
                set: {
                    providers: [
