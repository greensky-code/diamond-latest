...
import { TimelyFilingRulesComponent } from './timely-filing-rules.component';
...
describe('TimelyFilingRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with TimelyFilingRulesComponent setup', TimelyFilingRulesComponentSetup);
...
let de: DebugElement;
let comp: TimelyFilingRulesComponent;
let fixture: ComponentFixture<TimelyFilingRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(TimelyFilingRulesComponent);
...
function TimelyFilingRulesComponentSetup() {
    describe('TimelyFilingRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [TimelyFilingRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('TimelyFilingRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(TimelyFilingRulesComponent, {
                set: {
                    providers: [
