...
describe('ReasonComponent', () => {
    ...
    describe('with ReasonComponent setup', ReasonComponentSetup);
...
function ReasonComponentSetup() {
    describe('ReasonComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('ReasonComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ReasonComponent, {
                set: {
                    providers: [
