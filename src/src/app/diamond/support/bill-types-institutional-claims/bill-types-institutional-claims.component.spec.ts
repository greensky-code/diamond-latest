...
import { BillTypesInstitutionalClaimsComponent } from './bill-types-institutional-claims.component';
...
describe('BillTypesInstitutionalClaimsComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with BillTypesInstitutionalClaimsComponent setup', BillTypesInstitutionalClaimsComponentSetup);
...
let de: DebugElement;
let comp: BillTypesInstitutionalClaimsComponent;
let fixture: ComponentFixture<BillTypesInstitutionalClaimsComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(BillTypesInstitutionalClaimsComponent);
...
function BillTypesInstitutionalClaimsComponentSetup() {
    describe('BillTypesInstitutionalClaimsComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [BillTypesInstitutionalClaimsComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('BillTypesInstitutionalClaimsComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(BillTypesInstitutionalClaimsComponent, {
                set: {
                    providers: [
