...
describe('PriceRuleComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PriceRuleComponent setup', PriceRuleComponentSetup);
...
let de: DebugElement;
let comp: PriceRuleComponent;
let fixture: ComponentFixture<PriceRuleComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(PriceRuleComponent);
...
function PriceRuleComponentSetup() {
    describe('PriceRuleComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PriceRuleComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('PriceRuleComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PriceRuleComponent, {
                set: {
                    providers: [
