...
import { PcpAutoAssignRulesComponent } from './pcp-auto-assign-rules.component';
...
describe('PcpAutoAssignRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PcpAutoAssignRulesComponent setup', PcpAutoAssignRulesComponentSetup);
...
let de: DebugElement;
let comp: PcpAutoAssignRulesComponent;
let fixture: ComponentFixture<PcpAutoAssignRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(PcpAutoAssignRulesComponent);
...
function PcpAutoAssignRulesComponentSetup() {
    describe('PcpAutoAssignRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [PcpAutoAssignRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('PcpAutoAssignRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PcpAutoAssignRulesComponent, {
                set: {
                    providers: [
