...
import {AlertMessageService} from "../../../shared/components/alert-message/index";
...
describe('ModifierComponent', () => {
    ...
    describe('with ModifierComponent setup', ModifierComponentSetup);
...
function ModifierComponentSetup() {
    describe('ModifierComponent', function () {
        beforeEach(async(() => {
    ...
    describe('ModifierComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                .overrideComponent(ModifierComponent, {
                    set: {
                        providers: [
