...
describe('PriceRuleDetailComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with PriceRuleDetailComponent setup', PriceRuleDetailComponentSetup);
...
function PriceRuleDetailComponentSetup() {
    describe('PriceRuleDetailComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('PriceRuleDetailComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(PriceRuleDetailComponent, {
                set: {
                    providers: [
