...
import { ClaimDuplicateCheckRulesComponent } from './claim-duplicate-check-rules.component';
...
describe('ClaimDuplicateCheckRulesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with ClaimDuplicateCheckRulesComponent setup', ClaimDuplicateCheckRulesComponentSetup);
...
let de: DebugElement;
let comp: ClaimDuplicateCheckRulesComponent;
let fixture: ComponentFixture<ClaimDuplicateCheckRulesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(ClaimDuplicateCheckRulesComponent);
...
function ClaimDuplicateCheckRulesComponentSetup() {
    describe('ClaimDuplicateCheckRulesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ClaimDuplicateCheckRulesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('ClaimDuplicateCheckRulesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(ClaimDuplicateCheckRulesComponent, {
                set: {
                    providers: [
