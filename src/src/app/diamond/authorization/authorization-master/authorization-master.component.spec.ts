...
describe('AuthorizationMasterComponent', () => {
    ...
    describe('with AuthorizationMasterComponent setup', AuthorizationMasterComponentSetup);
...
let de: DebugElement;
let comp: AuthorizationMasterComponent;
...
function AuthorizationMasterComponentSetup() {
    describe('AuthorizationMasterComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('AuthorizationMasterComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthorizationMasterComponent, {
                set: {
                    providers: [
