...
describe('AuthorizationCodeComponent', () => {
    ...
    describe('with AuthorizationCodeComponent setup', AuthorizationCodeComponentSetup);
...
let de: DebugElement;
let comp: AuthorizationCodeComponent;
...
function AuthorizationCodeComponentSetup() {
    describe('AuthorizationCodeComponent', function () {
        beforeEach(async(() => {
...
function formsModuleSetup() {
    ...
    describe('AuthorizationCodeComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthorizationCodeComponent, {
                set: {
                    providers: [
