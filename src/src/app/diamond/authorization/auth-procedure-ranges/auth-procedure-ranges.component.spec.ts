...
import { AuthProcedureRangesComponent } from './auth-procedure-ranges.component';
...
describe('AuthProcedureRangesComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AuthProcedureRangesComponent setup', AuthProcedureRangesComponentSetup);
...
let de: DebugElement;
let comp: AuthProcedureRangesComponent;
let fixture: ComponentFixture<AuthProcedureRangesComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AuthProcedureRangesComponent);
...
function AuthProcedureRangesComponentSetup() {
    describe('AuthProcedureRangesComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AuthProcedureRangesComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AuthProcedureRangesComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthProcedureRangesComponent, {
                set: {
                    providers: [
