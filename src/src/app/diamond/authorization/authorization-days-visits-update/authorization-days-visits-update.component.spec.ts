...
import { AuthorizationDaysVisitsUpdateComponent } from './authorization-days-visits-update.component';
...
describe('AuthorizationDaysVisitsUpdateComponent', () => {
    beforeEach(() => {
        activatedRoute = new ActivatedRouteStub();
    });
    describe('with AuthorizationDaysVisitsUpdateComponent setup', AuthorizationDaysVisitsUpdateComponentSetup);
...
let de: DebugElement;
let comp: AuthorizationDaysVisitsUpdateComponent;
let fixture: ComponentFixture<AuthorizationDaysVisitsUpdateComponent>;
let page: Page;

function createComponent() {
    fixture = TestBed.createComponent(AuthorizationDaysVisitsUpdateComponent);
...
function AuthorizationDaysVisitsUpdateComponentSetup() {
    describe('AuthorizationDaysVisitsUpdateComponent', function () {
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AuthorizationDaysVisitsUpdateComponent]
             })
             .compileComponents()
...
function formsModuleSetup() {
    ...
    describe('AuthorizationDaysVisitsUpdateComponent', function () {
        beforeEach(async(() => {
            ...
            .overrideComponent(AuthorizationDaysVisitsUpdateComponent, {
                set: {
                    providers: [
