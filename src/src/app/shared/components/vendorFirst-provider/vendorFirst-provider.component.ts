...
@Component({
    selector: 'vendorFirst-provider',
    templateUrl: './vendorFirst-provider.component.html',
    styleUrls: ['./vendorFirst-provider.component.scss']
})
export class VendorFirstProviderComponent implements OnInit, AfterViewInit {

    @Input() searchModel: SearchModel;
    @Input() defaultLoad = true;
