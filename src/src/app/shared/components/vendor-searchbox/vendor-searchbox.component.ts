...
@Component({
    selector: 'vendor-searchbox',
    templateUrl: './vendor-searchbox.component.html',
    styleUrls: ['./vendor-searchbox.component.scss']
})
export class VendorSearchboxComponent implements OnInit, AfterViewInit {
