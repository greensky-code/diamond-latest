...
describe('ArCashReceiptService', () => {
  ...
  describe('#getArCashReceipts', () => {
    it('should return an Promise<ArCashReceipt[]>', () => {
      const arCashReceipt = [
        { seqCashReceipt: 1234, customerType: 'sample data', customerId: 'sample data', transDate: new Date(), transNo: 'sample data', transReceiptDate: new Date(), transactionType: 'sample data', companyCode: 'sample data', glRefCode: 'sample data', transAmt: 1234, subscriberId: 'sample data', description: 'sample data', seqCashBatchId: 1234, statementStatus: 'sample data', invoiceNo: 1234, postDate: new Date(), seqGpbilId: 1234, securityCode: 'sample data', insertDatetime: new Date(), insertUser: 'sample data', insertProcess: 'sample data', updateDatetime: new Date(), updateUser: 'sample data', updateProcess: 'sample data' },
        { seqCashReceipt: 1234, customerType: 'sample data', customerId: 'sample data', transDate: new Date(), transNo: 'sample data', transReceiptDate: new Date(), transactionType: 'sample data', companyCode: 'sample data', glRefCode: 'sample data', transAmt: 1234, subscriberId: 'sample data', description: 'sample data', seqCashBatchId: 1234, statementStatus: 'sample data', invoiceNo: 1234, postDate: new Date(), seqGpbilId: 1234, securityCode: 'sample data', insertDatetime: new Date(), insertUser: 'sample data', insertProcess: 'sample data', updateDatetime: new Date(), updateUser: 'sample data', updateProcess: 'sample data' },
        { seqCashReceipt: 1234, customerType: 'sample data', customerId: 'sample data', transDate: new Date(), transNo: 'sample data', transReceiptDate: new Date(), transactionType: 'sample data', companyCode: 'sample data', glRefCode: 'sample data', transAmt: 1234, subscriberId: 'sample data', description: 'sample data', seqCashBatchId: 1234, statementStatus: 'sample data', invoiceNo: 1234, postDate: new Date(), seqGpbilId: 1234, securityCode: 'sample data', insertDatetime: new Date(), insertUser: 'sample data', insertProcess: 'sample data', updateDatetime: new Date(), updateUser: 'sample data', updateProcess: 'sample data' }
