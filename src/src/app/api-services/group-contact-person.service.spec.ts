...
describe('GroupContactPersonService', () => {
  ...
  describe('#getGroupContactPersons', () => {
    it('should return an Promise<GroupContactPerson[]>', () => {
      const groupContactPerson = [
       {emailId:'sample data', primaryDistributionMethod:'sample data', updateProcess:'sample data', updateUser:'sample data', updateDatetime:'2018-01-01', insertProcess:'sample data', insertUser:'sample data', insertDatetime:'2018-01-01', securityCode:'sample data', faxNumber:'sample data', extension:'sample data', phoneNumber:'sample data', contactTitle:'sample data', contactName:'sample data', seqGroupId:1234, seqGroupContact:1234},
       {emailId:'sample data', primaryDistributionMethod:'sample data', updateProcess:'sample data', updateUser:'sample data', updateDatetime:'2018-01-01', insertProcess:'sample data', insertUser:'sample data', insertDatetime:'2018-01-01', securityCode:'sample data', faxNumber:'sample data', extension:'sample data', phoneNumber:'sample data', contactTitle:'sample data', contactName:'sample data', seqGroupId:1234, seqGroupContact:1234},
       {emailId:'sample data', primaryDistributionMethod:'sample data', updateProcess:'sample data', updateUser:'sample data', updateDatetime:'2018-01-01', insertProcess:'sample data', insertUser:'sample data', insertDatetime:'2018-01-01', securityCode:'sample data', faxNumber:'sample data', extension:'sample data', phoneNumber:'sample data', contactTitle:'sample data', contactName:'sample data', seqGroupId:1234, seqGroupContact:1234}

      ];
      service.getGroupContactPersons().then(users => {
  ...
  describe('#createGroupContactPerson', () => {
    var id = 1;
    it('should return an Promise<GroupContactPerson>', () => {
      const groupContactPerson: GroupContactPerson = {emailId:'sample data', primaryDistributionMethod:'sample data', updateProcess:'sample data', updateUser:'sample data', updateDatetime:'2018-01-01', insertProcess:'sample data', insertUser:'sample data', insertDatetime:'2018-01-01', securityCode:'sample data', faxNumber:'sample data', extension:'sample data', phoneNumber:'sample data', contactTitle:'sample data', contactName:'sample data', seqGroupId:1234, seqGroupContact:1234};
      service.createGroupContactPerson(groupContactPerson).then(response => {
  ...
  describe('#updateGroupContactPerson', () => {
    ...
    it('should return an Promise<GroupContactPerson>', () => {
      const groupContactPerson: GroupContactPerson = {emailId:'sample data', primaryDistributionMethod:'sample data', updateProcess:'sample data', updateUser:'sample data', updateDatetime:'2018-01-01', insertProcess:'sample data', insertUser:'sample data', insertDatetime:'2018-01-01', securityCode:'sample data', faxNumber:'sample data', extension:'sample data', phoneNumber:'sample data', contactTitle:'sample data', contactName:'sample data', seqGroupId:1234, seqGroupContact:1234};
      service.updateGroupContactPerson(groupContactPerson, id).then(response => {
         expect(response).toEqual(null);
      });
  ...
  describe('#deleteGroupContactPerson', () => {
    ...
    it('should call delete method with correct parameter', () => {
      service.deleteGroupContactPerson(id).then(response => {
         expect(response).toEqual(null);
      });
      const req = httpMock.expectOne(`${environment.apiUrl}/groupcontactpersons/${id}`);
