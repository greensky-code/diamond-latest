...
import {ProcUpdPharmacyPartnerIndService} from './proc-upd-pharmacy-partner-ind.stored-procedure.service';
...
describe('ProcUpdPharmacyPartnerIndService', () => {
    ...
    describe('#createProcUpdPharmacyPartnerInd', () => {
        var id = 1;
        it('should return an Promise<ProcUpdPharmacyPartnerInd>', () => {
            const procUpdPharmacyPartnerInd: ProcUpdPharmacyPartnerInd = {
                pGroupId: 'sample data',
                pPartnerInd: 'sample data',
                poRetcode: 1234,
