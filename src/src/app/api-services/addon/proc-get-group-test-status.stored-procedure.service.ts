...
import {ProcGetGroupTestStatusViewModel} from '../../api-models/addon/proc-get-group-test-status.view-model'
...
export class ProcGetGroupTestStatusService {
    ...
    private procGetGroupTestStatusUrl: string = `${environment.apiUrl}/procgetgroupteststatus`;
    ...
    procGetGroupTestStatus(procGetGroupTestStatus: ProcGetGroupTestStatus): Promise<ProcGetGroupTestStatusViewModel[]> {
        let body = JSON.stringify(procGetGroupTestStatus);
              return this.httpClient
                .post(this.procGetGroupTestStatusUrl, body, {
