...
import { AlertMessageService, AlertMessage } from '../shared/components/alert-message/index';
...
describe('AuthClaimLinkRuleService', () => {
  ...
  describe('#createAuthClaimLinkRule', () => {
    let id = 1;
    it('should return an Promise<AuthClaimLinkRule>', () => {
        let authClaimLinkRule: AuthClaimLinkRule;
        authClaimLinkRule = {
            lineOfBusiness: 'sample data',
            seqAuthType: 1234,
            authClosedStatus: 'sample data',
            authClosedReason: 'sample data',
            authNewStatus: 'sample data',
            authNewReason: 'sample data',
            authHeldStatus: 'sample data',
            authHeldReason: 'sample data',
            authDeniedStatus: 'sample data',
            authDeniedReason: 'sample data',
            authExpiredStatus: 'sample data',
            authExpiredReason: 'sample data',
            authQuantityExceededStatus: 'sample data',
            authQuantityExceededReason: 'sample data',
            authCostExceededStatus: 'sample data',
            authCostExceededReason: 'sample data',
            authDateStatus: 'sample data',
            authDateReason: 'sample data',
            authSecOpReqStatus: 'sample data',
            authSecOpReqReason: 'sample data',
            authGroupPlanStatus: 'sample data',
            authGroupPlanReason: 'sample data',
  ...
  describe('#updateAuthClaimLinkRule', () => {
    ...
    it('should return an Promise<AuthClaimLinkRule>', () => {
      ...
      service.updateAuthClaimLinkRule(authClaimLinkRule, id).subscribe((response: any) => {
         expect(response).toEqual(null);
      });
  ...
  describe('#deleteAuthClaimLinkRule', () => {
    ...
    it('should call delete method with correct parameter', () => {
      service.deleteAuthClaimLinkRule(id).subscribe((response: any) => {
         expect(response).toEqual(null);
      });
      const req = httpMock.expectOne(`${environment.apiUrl}/authclaimlinkrules/${id}`);
